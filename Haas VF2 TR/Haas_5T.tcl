...
#  HAAS_5T.tcl -
#
#  Created by xiongx  @  Tue Aug 05 18:05:34 2008 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_end_of_program_code               "91" 
...
#=============================================================
   ...
   MOM_force Once G_mode G_return G_motion Z
   MOM_do_template auto_tool_change_6
   MOM_force Once G_mode G_return G_motion Y
   MOM_do_template auto_tool_change_6_1
   MOM_force Once M
...
#=============================================================
   ...
   PB_CMD_d_register_force_address
}
...
#=============================================================
   ...
   MOM_do_template end_of_path_10
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   PB_CMD_operation_notes_1
   MOM_force Once fourth_axis fifth_axis
   MOM_do_template initial_move_7
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   COOLANT_SET ; CUTCOM_SET ; SPINDLE_SET ; RAPID_SET
   PB_CMD_operation_notes_1
   MOM_force Once G_mode G_adjust G_motion X Y Z S M_spindle user_add_2
   MOM_do_template initial_move_4
   MOM_force Once fourth_axis fifth_axis
   MOM_do_template initial_move_7
   MOM_force Once Z M_coolant
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_motion X Y Z fourth_axis fifth_axis}
   set rapid_traverse_xy_blk {G_motion X Y fourth_axis fifth_axis}
   set rapid_traverse_yz_blk {G_motion Y Z fourth_axis fifth_axis}
   set rapid_traverse_xz_blk {G_motion X Z fourth_axis fifth_axis}
...
#=============================================================
   ...
   MOM_set_seq_off
   PB_CMD_operation_notes
   MOM_force Once T
   MOM_do_template auto_tool_change_10
}
...
#=============================================================
proc PB_CMD_1st_piece { } {
#=============================================================
MOM_output_literal "IF \[ #599 EQ 1 \] THEN G90 G53 G00 Y0"
}
...
#=============================================================
proc PB_CMD_d_register_force_address { } {
#=============================================================
MOM_force once G_motion F D
}
...
#=============================================================
proc PB_CMD_f_force_address { } {
#=============================================================
MOM_force once G_motion F
}
...
return
  ...
  #*************************************************
   ...
   set tool_name [string range $mom_tool_name 0 25]
   ...
   switch $tool_type {
	 ...
	 set mom_tool_variable [expr ($mom_tool_number + 500)]
         set output [format "#%-3d= (%-25s)"  $mom_tool_variable $tool_name] 
      }
...
#=============================================================
  ...
  MOM_run_user_function [MOM_ask_env_var UGII_CAM_CUSTOM_DIR]ATTR_call.dll ufusr
...
#=============================================================
proc PB_CMD_program_number_auto { } {
#=============================================================
global mom_attr_PROGRAMVIEW_PROG_NUMBER

MOM_output_literal "O$mom_attr_PROGRAMVIEW_PROG_NUMBER"
}


#=============================================================
proc PB_CMD_program_number_man { } {
#=============================================================
MOM_output_literal "O ENTER OP AND LAST 3 DIGITS"
}
...
#=============================================================
global mom_group_name mom_logname mom_date mom_programmed_by_date mom_programmed_by

MOM_output_literal "( DATE- $mom_programmed_by_date )"
MOM_output_literal "(PROGRAMMED FOR HAAS5T - MAX RPM 8000 )"
MOM_output_literal "(PROGRAMMER- $mom_programmed_by )"
MOM_output_literal "(X AND Y AXIS ZERO IS CENTERLINE OF B AXIS )"
MOM_output_literal "(Z AXIS ZERO IS CENTERLINE OF A AXIS )"
MOM_output_literal "(A AXIS ZERO IS LOCATING FACE OF TABLE )"
MOM_output_literal "(B AXIS ZERO IS  )"
MOM_output_literal "  "
MOM_output_literal "(IF RUNNING PRODUCTION #599=0)"
MOM_output_literal "(IF RUNNING 1ST PIECE #599=1)"
MOM_output_literal "#599=0"
}


#=============================================================
proc PB_CMD_program_start_1 { } {
#=============================================================
MOM_output_literal "#500=116 (WORK COORDINATE OFFSET)"
}
