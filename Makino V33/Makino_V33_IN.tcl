########################## TCL Event Handlers ##########################
#
#  Created by suyo  @  Mon Oct 09 10:46:52 2006 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_coolant_code(THRU)                "77" 
...
#=============================================================
proc PB_CMD_UDE_uplevel { } {
#=============================================================
uplevel #0 {

  proc MOM_super_GI_ON { } {   
    
     global is_super_GI_ON
     set is_super_GI_ON 1
    
     MOM_force Once code_read_ahead super_GI super_GI_ON
     MOM_do_template super_GI
     MOM_do_template super_GI_ON
  }
...
if {[info exists is_super_GI_ON]} {
    if {$is_super_GI_ON} {
      
      set is_super_GI_ON 0
      MOM_force Once super_GI  super_GI_ON   
      MOM_do_template super_GI_OFF
    }
  }
...
#=============================================================
global is_first_tool_change

set is_first_tool_change 1
}
...
if [info exists is_first_tool_change] {

   if { $is_first_tool_change } {
      MOM_do_template tool_change_3
      set is_first_tool_change 0
      } else {
