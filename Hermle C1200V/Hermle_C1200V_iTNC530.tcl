...
#
#  Created by marks  @  Wed Aug 20 14:03:29 2008 Eastern Daylight Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_output_file_suffix                "I"  
...
#=============================================================
  ...
  global first_linear_move ; set first_linear_move 0
   ...
   PB_CMD_Start_of_Operation_force_addresses_1
   MOM_set_seq_off
   MOM_set_seq_on
...
#=============================================================
  ...
  # Pass tool name to VNC for simulation.
   ...
   MOM_do_template auto_tool_change_9
...
set mom_rotation_angle 0.0
set mom_rotate_axis_type AAXIS
...
if { $cycle_type_number == 200 }  {
    	MOM_do_template cycle_block_200	
    }

if { $cycle_type_number == 201 }  {
    	MOM_do_template cycle_block_201	
    }

if { $cycle_type_number == 202 }  {
    	MOM_do_template cycle_block_202	
    }

if { $cycle_type_number == 207 }  {
    	MOM_do_template cycle_block_207	
    }
...
#=============================================================
global mom_group_name mom_logname mom_date mom_output_file_basename

MOM_output_literal ";(Part Number: $mom_output_file_basename  	Revision Level:  )"
MOM_output_literal ";(Date: $mom_date)"
MOM_output_literal ";(Machine:  Hermle - Max. RPM 16,000 )"
MOM_output_literal ";(Programmer:   )"
}
...
#=============================================================
  ...
  global turret_current mom_warning_info
    ...
    if {$mom_tool_head != "NONE" &&  $mom_tool_head != "NONE"} {
