...
#
#  Created by suyo  @  Mon Oct 08 16:25:04 2007 China Standard Time
...
#=============================================================
   MOM_do_template end_of_program_M25
...
#=============================================================
  global cycle_init_flag
   ...
   PB_CMD_cycle_pecking
   MOM_do_template cycle_drill_break_chip_2
   set cycle_init_flag FALSE
}
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_motion X Y Z S M_spindle Text G_cutcom}
   set rapid_traverse_xy_blk {G_motion X Y S M_spindle Text G_cutcom}
   set rapid_traverse_yz_blk {G_motion Y Z S M_spindle Text G_cutcom}
   set rapid_traverse_xz_blk {G_motion X Z S M_spindle Text G_cutcom}
...
if { [string match *M* $mom_o_buffer] } {		

} elseif { [string match *TOOL* $mom_o_buffer] } { 
	
} elseif { [string match *\;* $mom_o_buffer] } {
	
} elseif { [string match *CYCL* $mom_o_buffer] } {
	
} elseif { [string match *Q* $mom_o_buffer] } {
	
} elseif { [string match *CC* $mom_o_buffer] } {
	
} else {
append mom_o_buffer " M"
}
...
if { $mom_pos(2) != $mom_prev_pos(2) } {
  ...
  if {$cycle_init_flag == "TRUE"} {
    ...
    MOM_do_template cycle_pecking_1
    MOM_do_template cycle_pecking_2
    MOM_do_template cycle_pecking_3
    MOM_do_template cycle_pecking_4
    MOM_do_template cycle_pecking_5
    MOM_do_template cycle_pecking_6
}
}
...
if { $mom_pos(2) != $mom_prev_pos(2) } {
  ...
  if {$cycle_init_flag == "TRUE"} {
    ...
    MOM_do_template cycle_tapping_1
    MOM_do_template cycle_tapping_2
    MOM_do_template cycle_tapping_3
    MOM_do_template cycle_tapping_4
    MOM_do_template cycle_tapping_5   
}
}
