...
#
#  Created by suyo  @  Fri Jan 11 09:58:46 2008 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_cycle_tap_code                    "84.2"
...
#=============================================================
   ...
   MOM_do_template cancel_cut_adjust
   MOM_force Once G
   MOM_do_template machine_origin
   MOM_do_template coolant_off
   MOM_do_template spindle_off
   MOM_force Once G X Y
   MOM_do_template home_x_y_axis
   MOM_force Once G
   MOM_do_template machine_origin
   PB_CMD_m0_m1
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_plane G_motion G_mode G X Y Z fourth_axis M_coolant}
   set rapid_traverse_xy_blk {G_plane G_motion G_mode G X Y fourth_axis M_coolant}
   set rapid_traverse_yz_blk {G_plane G_motion G_mode G Y Z fourth_axis M_coolant}
   set rapid_traverse_xz_blk {G_plane G_motion G_mode G X Z fourth_axis M_coolant}
...
#=============================================================
   ...
   MOM_do_template tool_change
   MOM_force Once G Y
   MOM_do_template home_y_axis
   PB_CMD_tool_change_force_addresses
   PB_CMD_first_tool_change
   MOM_force Once M
