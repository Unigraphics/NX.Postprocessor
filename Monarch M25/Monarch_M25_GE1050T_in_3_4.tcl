...
#
#  Created by zhang  @  Thu Apr 24 21:05:37 2008 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_spindle_range_code(1)             "51" 
  set mom_sys_spindle_param(1,max)              "30" 
  set mom_sys_spindle_param(1,min)              "0"  
  set mom_sys_spindle_range_code(2)             "52" 
  set mom_sys_spindle_param(2,max)              "103"
  set mom_sys_spindle_param(2,min)              "17" 
  set mom_sys_spindle_range_code(3)             "53" 
  set mom_sys_spindle_param(3,max)              "360"
  set mom_sys_spindle_param(3,min)              "60" 
  set mom_sys_spindle_range_code(4)             "54" 
  set mom_sys_spindle_param(4,max)              "1250"
  set mom_sys_spindle_param(4,min)              "208"
  ...
  set mom_sys_post_description                  "This is the post for Monarch M25 GE1050T;\n\
                                                 4_9_01 Range Spindle down;\n\
                                                 4_9_02 Travel limited down;\n\
                                                 4_10     need info feedbak;\n\
                                                 4_18     Get info;\n\
                                                 4_21     Work on the post;\n\
                                                 4_22     Testing and go on;\n\
                                                 4_24     Update the post."
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   PB_CMD_spindle_range_M_code
   PB_CMD_spindle_sfm_prestart
   PB_CMD_output_spindle
   MOM_do_template initial_move_m_58
...
#=============================================================
  ...
  global first_linear_move
   ...
   PB_CMD_output_spindle
   MOM_do_template linear_move_g94
...
#=============================================================
proc PB_CMD_MOM_delay { } {
#=============================================================
#
#  This command for the MOM_delay
#  Do not output template delay Before Tool change
#

uplevel #0 {
proc MOM_delay { } {
global mom_delay_flag
   if { $mom_delay_flag == 1 } {   
   PB_DELAY_TIME_SET
   MOM_do_template delay
}
...
if { $mom_delay_value == 0 } { 
MOM_suppress once user_G_04
MOM_suppress once dwell
MOM_force once T
MOM_do_template auto_tool_change
} elseif { $mom_delay_value != 0 } { 
MOM_force once user_G_04
...
#=============================================================
proc PB_CMD_reset_delay_flag { } {
#=============================================================
global mom_delay_flag
set mom_delay_flag 0
}
...
#=============================================================
proc PB_CMD_set_delay_flag { } {
#=============================================================
global mom_delay_flag
set mom_delay_flag 1
}
...
#=============================================================
proc PB_CMD_spindle_range_M_code { } {
#=============================================================
global mom_spindle_range  mom_spindle_speed mom_warning_info
global mom_spindle_speed
global mom_warning_info
MOM_force once M_range 
#  Set range code.
if { $mom_spindle_range == 1 || 
     $mom_spindle_range == 2 || 
     $mom_spindle_range == 3 || 
     $mom_spindle_range == 4 } { MOM_do_template spindle_range } 
if { $mom_spindle_speed < 30 } {
    set mom_spindle_speed 30
     set mom_warning_info "The speed is lower than the min speed"
     MOM_catch_warning
   } elseif { $mom_spindle_speed > 1250 } {
    set mom_spindle_speed 1250
