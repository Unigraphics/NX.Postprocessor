...
#
#  Created by zhang  @  Tue Jul 29 15:42:39 2008 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_post_description                  "This is the post for Yama_Seiki_VMB-1600."
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_y_axis_limit                      "31.5"
  set mom_kin_z_axis_limit                      "31.5"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_motion G G_mode X Y Z S M_spindle}
   set rapid_traverse_xy_blk {G_motion G G_mode X Y S M_spindle}
   set rapid_traverse_yz_blk {G_motion G G_mode Y Z S M_spindle}
   set rapid_traverse_xz_blk {G_motion G G_mode X Z S M_spindle}
...
#=============================================================
proc PB_CMD_cycle_tap_spindle { } {
#=============================================================
global pop_cycle_flag
global mom_cycle_option
#MOM_output_literal $pop_cycle_flag
#MOM_output_literal "mom_cycle_option = $mom_cycle_option"
if { $pop_cycle_flag == "TRUE" } {
        if { [info exists mom_cycle_option] && $mom_cycle_option == "OPTION" } {
		MOM_force once S M_29
		MOM_do_template cycle_tap_spindle
	}
        set pop_cycle_flag "FLASE"
} else {
#	MOM_suppress once S
}
}
...
#=============================================================
MOM_do_template end_of_path_return_Z
}
...
#=============================================================
proc PB_CMD_int_vars { } {
#=============================================================
#init the flag of gigud tap = true;
# if flag = true output M29 else not output

global pop_cycle_flag
set pop_cycle_flag    "TRUE"
}
