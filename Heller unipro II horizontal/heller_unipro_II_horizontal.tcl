...
global mom_tool_axis cycle_P90  cabec_flag
    ...
    if {$cabec_flag == 0} {
        MOM_output_literal "(C, POSICAO HORIZONTAL)"
        set cabec_flag 1
    }
    MOM_output_literal "M67"
    set cycle_P90  "Z"
...
if {$cycle_P1 != $mom_cycle_feed_to_pos(2)} {
    set repete  1
    set cycle_P1   $mom_cycle_feed_to_pos(2)
}
