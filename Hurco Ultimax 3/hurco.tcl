########################## TCL Event Handlers ##########################
#
#  Created by smithm  @  Thu Oct 27 17:13:52 2005 GMT Standard Time
...
#=============================================================
   PB_CMD_output_total_cycle_time
   MOM_do_template retract_toZ_home
...
#=============================================================
   ...
   PB_CMD_output_operation_cycle_time
   global mom_sys_in_operation
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_cutcom G_motion G_mode X Y Z M_coolant}
   set rapid_traverse_xy_blk {G_cutcom G_motion G_mode X Y M_coolant}
   set rapid_traverse_yz_blk {G_cutcom G_motion G_mode Y Z M_coolant}
   set rapid_traverse_xz_blk {G_cutcom G_motion G_mode X Z M_coolant}
...
#=============================================================
  global cycle_init_flag
   ...
   MOM_do_template cycle_parameters
   PB_CMD_check_peck_depths
   MOM_do_template cycle_drill_deep
   PB_CMD_reinstate_cycle_step
   set cycle_init_flag FALSE
}
...
#=============================================================
proc PB_CMD_check_part_units { } {
#=============================================================
global mom_output_unit

switch $mom_output_unit {
                         MM {# Do nothing}
                         IN {MOM_abort "\n\n ***** Incorrect Output Units Requested ($mom_output_unit) ***** \n\n"}
                        }
}


#=============================================================
proc PB_CMD_check_peck_depths { } {
#=============================================================
...
set zdepth [expr ($mom_cycle_rapid_to - $mom_cycle_feed_to)]

if {$mom_cycle_step1 > $zdepth} {MOM_abort "\n\n***** First peck depth should be less than total drill depth in operation $mom_operation_name *****\n\n"}
if {$mom_cycle_step2 > $zdepth} {MOM_abort "\n\n***** Second peck depth should be less than total drill depth in operation $mom_operation_name *****\n\n"}

if {![info exists mom_cycle_step2] || [expr abs($mom_cycle_step2)] < 0.0001} {MOM_suppress once cycle_step1}
if {![info exists mom_cycle_step1] || [expr abs($mom_cycle_step1)] < 0.0001} {MOM_abort "\n\n***** Peck depth not set in operation $mom_operation_name *****\n\n"}
}
...
#=============================================================
global mks_min_tool_number
global mks_max_tool_number
global mom_tool_number
global mom_operation_name

if {$mom_tool_number < $mks_min_tool_number || $mom_tool_number > $mks_max_tool_number} {MOM_abort "\n\n ***** Invalid Tool Number $mom_tool_number in operation $mom_operation_name *****\n\n"}
}
...
global mks_min_tool_number
global mks_max_tool_number
global mom_decel_mode
global mom_decel_code
global mom_cycle_pull_off_x
global mom_cycle_pull_off_y
global mks_old_cycle_time

set mks_min_tool_number 1
set mks_max_tool_number 99
set mom_decel_mode "OFF"
set mom_cycle_pull_off_x "-1"
set mom_cycle_pull_off_y "0"

set mom_decel_code(OFF) 64
set mom_decel_code(ON) 61
set mks_old_cycle_time 0
}


#=============================================================
proc PB_CMD_invalid_cycle_type { } {
#=============================================================
global mom_motion_event
global mom_operation_name

regsub "_move" $mom_motion_event "" cycle_name

MOM_abort "\n\n ***** Unsupported Cycle Type \"$cycle_name\" in Operation $mom_operation_name*****\n\n"
}
...
# The Hurco Ultimax 3 control does not support operator messages
# This procedure replaces standard operator message processing, but does nothing
}
}


#=============================================================
proc PB_CMD_output_operation_cycle_time { } {
#=============================================================
global mks_old_cycle_time
global mom_machine_time
global mom_operation_name

set mks_operation_time [format %.2f [expr ($mom_machine_time - $mks_old_cycle_time)]]
set mks_old_cycle_time $mom_machine_time

MOM_output_to_listing_device "Cycle time for operation $mom_operation_name is $mks_operation_time minutes"
}


#=============================================================
proc PB_CMD_output_total_cycle_time { } {
#=============================================================
global mom_machine_time

MOM_output_to_listing_device "\nTotal machining time is [format %.2f $mom_machine_time]"
}
...
#=============================================================
# Customer: Britax
global pp_version_number
set pp_version_number "2.0"

# V1.0, 23rd November 2004
#
# Limitiations
#
# 1) G92 not supported
# 2) G09 not supported (G61/G64 modal deceleration codes are supported)
# 3) M25 not supported

# V1.1, 30th November 2004
#
# 1) Cycle times output to information window
# 2) Post preocessor version output to information window
# 3) "ptp" file extenstio changed to "hnc"
# 4) Set spindle sppeed range to 80-4000

# V1.2, 8th December 2004
#
# 1) Output block numbers

# V2.0, 27th Ocotober 2005
#
# 1) Update to Post Builder 3.4.1
# 2) Add helcial support

MOM_output_to_listing_device "Post processor version $pp_version_number\n"
}


#=============================================================
proc PB_CMD_reinstate_cycle_step { } {
#=============================================================
MOM_suppress off cycle_step1
}
...
#=============================================================
proc PB_CMD_reset_drill_parameters { } {
#=============================================================
MOM_force once cycle_step cycle_step1 Z_depth
MOM_force once cycle_dwell cycle_pull_off_x cycle_pull_off_y
}
...
#=============================================================
MOM_force once G_mode G_motion G_adjust G_circ_mode G_decel_mode G_plane
MOM_force once F X Y Z I J K S M_coolant M_spindle cycle_dwell
MOM_force once cycle_pull_off_x cycle_pull_off_y
}
