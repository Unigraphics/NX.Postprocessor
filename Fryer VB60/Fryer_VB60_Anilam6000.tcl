...
#
#  Created by wrightj  @  Fri Dec 14 15:47:57 2007 Central Daylight Time
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_rapid_feed_rate                   "100"
  set mom_kin_rotary_axis_method                "PREVIOUS"
  set mom_kin_spindle_axis(0)                   "0.0"
  set mom_kin_spindle_axis(1)                   "0.0"
  set mom_kin_spindle_axis(2)                   "1.0"
  set mom_kin_tool_change_time                  "12.0"
  set mom_kin_x_axis_limit                      "32" 
  set mom_kin_y_axis_limit                      "17" 
  set mom_kin_z_axis_limit                      "19" 
...
#MOM_output_literal "----$mom_cycle_delay"
return
} else {
#MOM_output_literal "mom_cycle_delay doesn't exist"
...
#MOM_output_literal "$mom_next_oper_has_tool_change"
