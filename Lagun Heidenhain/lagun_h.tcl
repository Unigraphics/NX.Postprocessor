...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_motion X Y Z S Text}
   set rapid_spindle_x_blk {G_motion X S Text}
   set rapid_spindle_y_blk {G_motion Y S Text}
   set rapid_spindle_z_blk {G_motion Z S Text}
   set rapid_traverse_blk {G_motion X Y Z S Text M_spindle cutter_comp}
   set rapid_traverse_xy_blk {G_motion X Y S Text M_spindle cutter_comp}
   set rapid_traverse_yz_blk {G_motion Y Z S Text M_spindle cutter_comp}
   set rapid_traverse_xz_blk {G_motion X Z S Text M_spindle cutter_comp}
...
#=============================================================
  global cycle_init_flag
   ...
   MOM_do_template cycle_drill_4
   MOM_do_template cycle_drill_5
   MOM_do_template cycle_drill_6
   MOM_do_template cycle_drill_7
   MOM_do_template cycle_drill_8
   MOM_do_template cycle_drill_9
   MOM_do_template cycle_drill_10
   MOM_set_seq_on
...
#=============================================================
  global cycle_init_flag
   ...
   MOM_set_seq_off
   MOM_do_template cycle_drill_dwell_3
   MOM_do_template cycle_drill_dwell_4
   MOM_do_template cycle_drill_dwell_5
   MOM_do_template cycle_drill_dwell_6
   MOM_do_template cycle_drill_dwell_7
   MOM_do_template cycle_drill_dwell_8
   MOM_do_template cycle_drill_dwell_9
   MOM_do_template cycle_drill_dwell_10
   MOM_set_seq_on
...
#=============================================================
  global cycle_init_flag
   ...
   MOM_set_seq_off
   MOM_do_template cycle_drill_deep_3
   MOM_do_template cycle_drill_deep_4
   MOM_do_template cycle_drill_deep_5
   MOM_do_template cycle_drill_deep_6
   MOM_do_template cycle_drill_deep_7
   MOM_do_template cycle_drill_deep_8
   MOM_do_template cycle_drill_deep_9
   MOM_do_template cycle_drill_deep_10
   MOM_set_seq_on
...
#=============================================================
  global cycle_init_flag
   ...
   MOM_set_seq_off
   MOM_do_template cycle_drill_break_chip_3
   MOM_do_template cycle_drill_break_chip_4
   MOM_do_template cycle_drill_break_chip_5
   MOM_do_template cycle_drill_break_chip_6
   MOM_do_template cycle_drill_break_chip_7
   MOM_do_template cycle_drill_break_chip_8
   MOM_do_template cycle_drill_break_chip_9
   MOM_do_template drill_break_chip_1
   MOM_do_template drill_break_chip_2
   MOM_do_template drill_break_chip_3
   MOM_do_template drill_break_chip_4
   MOM_do_template drill_break_chip_5
   MOM_do_template drill_break_chip_6
   MOM_set_seq_on
...
#=============================================================
  global cycle_init_flag
   ...
   MOM_set_seq_off
   MOM_do_template cycle_bore_no_drag_3
   MOM_do_template cycle_bore_no_drag_4
   MOM_do_template cycle_bore_no_drag_5
   MOM_do_template cycle_bore_no_drag_6
   MOM_do_template cycle_bore_no_drag_7
   MOM_do_template cycle_bore_no_drag_8
   MOM_do_template cycle_bore_no_drag_9
   MOM_do_template cycle_bore_no_drag_10
   MOM_do_template cycle_bore_no_drag_10
   MOM_set_seq_on
...
# options for full path name, file name only , uppercase
  ...
  MOM_output_literal ";COMPAÑIA GENERAL DE ACEROS"
  MOM_output_literal ";POSTPROCESADOR LAGUN"
}
...
#***************************
 set user_tcl_file ${cam_post_dir}LAGUN_H_user.tcl
