...
#
#  Created by suyo  @  Fri Apr 11 16:54:17 2008 China Standard Time
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   PB_CMD_spindle_table
   set rapid_spindle_blk {G_motion RZ X Y Z F H}
   set rapid_spindle_x_blk {G_motion RZ X F H}
   set rapid_spindle_y_blk {G_motion RZ Y F H}
   set rapid_spindle_z_blk {G_motion RZ Z F H}
   ...
   set rapid_spindle_mod {G_motion RZ rapid3}
...
#PB_CMD_positive_z_down
   ...
   if {![info exists saved_z]} {set saved_z $mom_pos(2)}   
...
if { $last_motion_event == "initial_move" || $last_motion_event == "rapid_move" } {  
 ...
 if { $mom_pos(0) == $mom_prev_pos(0) && $mom_pos(1) == $mom_prev_pos(1) } {
     MOM_suppress once G_motion X Y
   }
}
