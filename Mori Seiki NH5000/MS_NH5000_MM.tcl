...
#  MS_NH5000_MM.tcl -
#
#  Created by xiongx  @  Fri Jan 16 13:46:53 2009 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_coolant_code(MIST)                "92" 
  set mom_sys_coolant_code(THRU)                "88" 
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_rapid_feed_rate                   "14000"
  ...
  set mom_kin_x_axis_limit                      "730"
  set mom_kin_y_axis_limit                      "730"
  set mom_kin_z_axis_limit                      "850"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_mode G_motion G X Y Z}
   set rapid_traverse_xy_blk {G_mode G_motion G X Y}
   set rapid_traverse_yz_blk {G_mode G_motion G Y Z}
   set rapid_traverse_xz_blk {G_mode G_motion G X Z}
...
#=============================================================
proc PB_CMD_coolant_checker { } {
#=============================================================
uplevel #0 {
#set mom_sys_coolant_code(Oil-hole drill) "50"
#set mom_sys_coolant_code(Air blow) "51"
#set mom_sys_coolant_code(Dust collector air blow) "52"
#set mom_sys_coolant_code(Sensor air blow) "53"
#set mom_sys_coolant_code(Shower) "80"
#set mom_sys_coolant_code(AIR) "51"
#set mom_sys_coolant_code(AIR) "51"
}
}
...
#=============================================================
MOM_output_literal "coolant off"

  global mom_coolant_status mom_coolant_mode
 # global mom_sys_coolant_code

MOM_output_literal "$mom_coolant_status"
MOM_output_literal "$mom_coolant_mode"
#MOM_output_literal "$mom_sys_coolant_code($mom_coolant_status)"
}
...
#=============================================================
#global mom_fourth_axis
global mom_out_angle_pos

if { $mom_out_angle_pos(0) == 0 } { return }
MOM_output_literal "$mom_out_angle_pos(0)"
MOM_output_literal "G28 B0"
}
...
MOM_output_literal "$mom_pos(1)"
MOM_output_literal "$mom_pos(2)"
}
...
proc COOLANT_SET { } {
  ...
  set mom_sys_coolant_code(TAP)                 "27" 
  set mom_sys_coolant_code(OFF)                 "9"  
  set mom_sys_coolant_code(OILHOLEDRILL)      "50" 
  set mom_sys_coolant_code(AIRBLOW)            "51"  
  set mom_sys_coolant_code(DUSTCOLLECTORAIRBLOW) "52" 
  set mom_sys_coolant_code(SENSORAIRBLOW)      "53" 
  set mom_sys_coolant_code(SHOWER)                "80" 
  set mom_sys_coolant_code(58)                  "58"  
  set mom_sys_coolant_code(59)                 "59" 
  set mom_sys_coolant_code(81)                 "81" 
  set mom_sys_coolant_code(89)                 "89" 

#when type=ON, mom_coolant_status=SAME
...
#  if { $mom_coolant_status == "ON" } {
  if { $mom_coolant_status == "OFF"} {
    switch $mom_coolant_mode {
      AIRBLOW                    { set mom_coolant_status 59 }
      DUSTCOLLECTORAIRBLOW       { set mom_coolant_status 58 }
      SENSORAIRBLOW              { set mom_coolant_status 58 }
      SHOWER                     { set mom_coolant_status 81 }
      THRU                       { set mom_coolant_status 89 }
    }
  } elseif { $mom_coolant_status != "SAME"} {
...
switch $mom_coolant_mode {
  ...
  "M81(SHOWER)" {
    MOM_output_literal "M81"
  }
  "M89(THRU)" {
    MOM_output_literal "M89"
  }
}
}
