########################## TCL Event Handlers ##########################
#
#  Created by suyo  @  Fri Dec 01 09:49:22 2006 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_coolant_code(FLOOD)               "27" 
  set mom_sys_coolant_code(MIST)                "7"  
  set mom_sys_coolant_code(THRU)                "28" 
  set mom_sys_coolant_code(TAP)                 "29" 
  ...
  set mom_sys_post_description                  "Cincinnati Milacron Arrow 750"
...
#=============================================================
   PB_CMD_suppress_leader
   MOM_force Once spindle_axis_retract
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   MOM_force Once G_plane G G_mode G_feed G_spin G_motion F Text T M
   MOM_do_template tool_change_1_1
   PB_CMD_end_of_alignment_character
   MOM_force Once G_motion T
   MOM_do_template tool_change_2_11
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   PB_CMD_tool_change_force_addresses
   PB_CMD_start_of_alignment_character
   MOM_force Once G G_mode G_feed G_spin G_motion F T M
   MOM_do_template tool_change_1
   PB_CMD_end_of_alignment_character
   MOM_force Once G_motion T
   MOM_do_template tool_change_21
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_mode G_motion X Y Z M_coolant}
   set rapid_spindle_x_blk {G_mode G_motion X M_coolant}
   set rapid_spindle_y_blk {G_mode G_motion Y M_coolant}
   set rapid_spindle_z_blk {G_mode G_motion Z M_coolant}
...
#=============================================================
  ...
  global first_linear_move ; set first_linear_move 0
   ...
   MOM_output_literal "(MSG, OPERATION: $mom_operation_name)"
   global mom_tool_number mom_tool_name
   MOM_output_literal "(MSG, TOOL $mom_tool_number: $mom_tool_name)"
   MOM_set_seq_on
...
#=============================================================
   ...
   MOM_set_seq_off
   MOM_do_template rewind_stop_code
   MOM_force Once G_plane G G_mode G_feed G_spin spindle_axis_retract
   MOM_do_template absolute_mode_1
   global mom_part_name
   MOM_output_literal "(MSG, PART: $mom_part_name)"
   global mom_group_name
   MOM_output_literal "(MSG, PROGRAM: $mom_group_name)"
   global mom_date
   MOM_output_literal "(MSG, $mom_date)"
   global mom_output_mode mom_output_unit
   MOM_output_literal "(MSG, OUTPUT IN  $mom_output_mode $mom_output_unit )"
   MOM_set_seq_on
}
...
#=============================================================
proc PB_CMD_suppress_leader { } {
#=============================================================
global mom_seqnum

MOM_suppress Once N 
MOM_output_literal ":[expr int($mom_seqnum)]"
set mom_seqnum [expr $mom_seqnum+1]
}
