...
#
#  Created by marks  @  Wednesday, September 24, 2008 1:32:02 PM Eastern Daylight Time
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_5th_axis_max_limit                "25" 
  set mom_kin_5th_axis_min_incr                 "0.001"
  set mom_kin_5th_axis_min_limit                "-25"
...
#=============================================================
  global cycle_name
  global mom_out_angle_pos
  global simulate_cycle


  if {$mom_out_angle_pos(0) != 0 || $mom_out_angle_pos(1) != 0} {
     set simulate_cycle 1
     return
     } else {
     set simulate_cycle 0
      }
