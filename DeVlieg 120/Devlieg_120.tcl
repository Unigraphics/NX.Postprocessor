...
#  Devlieg_120.tcl -
#
#  Created by xiongx  @  Fri Aug 01 17:53:40 2008 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_cycle_ret_code(AUTO)              "1"  
  ...
  set mom_sys_tool_change_code                  "10" 
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_x_axis_limit                      "80" 
  set mom_kin_y_axis_limit                      "80" 
  set mom_kin_z_axis_limit                      "70" 
...
#=============================================================
   ...
   MOM_force Once G_motion Z M_spindle
   MOM_do_template end_of_path_5
   MOM_set_seq_off
   MOM_force Once M
...
#=============================================================
proc PB_CMD_create_tool_list_1 { } {
#=============================================================
#  Place this custom command in either the start of program
#  or the end of program event marker to generate a tool list
#  in your NC file.
...
#=============================================================
MOM_force once G_motion G_cutcom F D
}
...
return
  ...
  #*************************************************
   ...
   switch $tool_type {
	 ...
	 set mom_tool_variable [expr ($mom_tool_number + 9000 )]
         set output [format ";H%-4d;__TOOL_%-2d__%-30s"  $mom_tool_variable $mom_tool_number $tool_name] 
      }
...
MOM_output_literal ";TOOL_$mom_tool_number"
...
#=============================================================
  ...
  MOM_output_literal ";PART NUMBER:__$part_nbr"
  MOM_output_literal ";DESCRIPTION:__$part_des"
  MOM_output_literal ";REVISION:__$part_rev"
  MOM_output_literal ";MATERIAL:__$part_mat"
}
...
#=============================================================
global mom_file_name

MOM_output_literal ";$mom_file_name"
}
...
MOM_output_literal ";DATE_$mom_programmed_by_date"
MOM_output_literal ";PROGRAMMED_FOR_DVL120"
MOM_output_literal ";PROGRAMMER_$mom_programmed_by"
}
