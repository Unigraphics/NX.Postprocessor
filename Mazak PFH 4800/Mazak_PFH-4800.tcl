...
#  Mazak_PFH-4800.tcl -
#
#  Created by plsekma  @  Wed Aug 13 06:59:53 2008 Eastern Daylight Time
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   MOM_force Once G_motion G_mode G fourth_axis
   MOM_do_template initial_move_1
   MOM_force Once G_motion X Y S M_spindle M_coolant
...
#=============================================================
   ...
   PB_CMD_custom_command_2
   MOM_force Once G_adjust G_motion H
...
#=============================================================
   ...
   PB_CMD_user_defined_text_commands
   PB_CMD_file_header
   MOM_output_literal "(MAZAK PFH-4800 UG POST)"
   PB_CMD_set_variables
...
#=============================================================
proc PB_CMD_file_header { } {
#=============================================================
 # This command can be used to output file information
         ...
         MOM_output_literal "O[string toupper $mom_group_name]"
         MOM_output_literal "(FILE: [string toupper $mom_part_name])"
         MOM_output_literal "(POSTED BY: [string toupper $mom_logname])"
         MOM_output_literal "(POST DATE: [string toupper $mom_date])"
         MOM_output_literal "([string toupper $mom_group_name])"
}
...
#=============================================================
proc PB_CMD_tool_text { } {
#=============================================================
# for  the text area in machine control

global mom_tool_text
global mom_tool_text_defined

if { $mom_tool_text_defined == 1 } { 

set mom_tool_text [string toupper $mom_tool_text]
...
#
  uplevel #0 {
    ...
    #_______________________________________________________________________________
      ...
      "ROTATE" 
           {
             set mom_rotate_defined 1
             set mom_rotate $mom_record_text
             MOM_rotate
           }
      "PPRINT" 
           {
      ...
      default
           {
             if {[info exists mom_user_defined_text mom_rotation_text]} {
               MOM_output_literal "${mom_sys_control_out}${mom_user_defined_text}${mom_rotation_text}${mom_sys_control_in}"
             }
           }
    }
  }
