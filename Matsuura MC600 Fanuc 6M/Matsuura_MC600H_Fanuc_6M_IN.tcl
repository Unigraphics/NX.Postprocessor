...
#
#  Created by suyo  @  Tue Aug 14 10:21:29 2007 China Standard Time
...
#=============================================================
   ...
   MOM_do_template gohome_xyplane
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_spindle_blk {G_adjust G_motion G_mode X Y Z fourth_axis H M_coolant}
   set rapid_spindle_x_blk {G_adjust G_motion G_mode X fourth_axis H M_coolant}
   set rapid_spindle_y_blk {G_adjust G_motion G_mode Y fourth_axis H M_coolant}
   set rapid_spindle_z_blk {G_adjust G_motion G_mode Z fourth_axis H M_coolant}
   set rapid_traverse_blk {G_motion G_mode G X Y Z fourth_axis}
   set rapid_traverse_xy_blk {G_motion G_mode G X Y fourth_axis}
   set rapid_traverse_yz_blk {G_motion G_mode G Y Z fourth_axis}
   set rapid_traverse_xz_blk {G_motion G_mode G X Z fourth_axis}
