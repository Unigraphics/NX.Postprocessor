...
#  Daewoo_Puma.tcl -
#
#  Created by marks  @  Thu Sep 18 14:01:23 2008 Eastern Daylight Time
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_x_axis_limit                      "16" 
  set mom_kin_y_axis_limit                      "63" 
  set mom_kin_z_axis_limit                      "63" 
...
#=============================================================
MOM_output_text "G0 G59 X20. Z#500 M9"
}
...
#=============================================================
MOM_output_text "G0 G59 X20. Z#500"
}
...
MOM_output_literal "($fname)" 
MOM_output_literal "(MACHINE: PUMA)"
...
#=============================================================
MOM_output_text "(===================================)"
MOM_output_text "(MAKE SURE FIXTURE OFFSET G59)"
MOM_output_text "(IS SET TO X0 Z0 FOR SAFE INDEX)"
MOM_output_text "G10L2P6X0Z0"
MOM_output_text "(===================================)"
MOM_output_text "(THIS LINE SETS SAFE INDEX POSITION IN Z AXIS FOR TOOL CHANGE)"
MOM_output_text "(MEASURED FROM THE BACK OF THE CHUCK)"
MOM_output_text "(USE CAUTION WHEN EDITING, A BAD VALUE CAN RESULT IN A CRASH)"
MOM_output_text "#500=40."
}
