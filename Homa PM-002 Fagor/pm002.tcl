########################## TCL Event Handlers ##########################
#
#  Created by ugii  @  Fri Aug 13 15:19:15 2004 E. South America Daylight Time
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   COOLANT_SET ; CUTCOM_SET ; SPINDLE_SET ; RAPID_SET
   MOM_force Once G F S M_spindle
...
################################################################################
#
# This is a 3-Axis Vertical Milling Machine.
#
# Homma PM-002 / Fagor.
#
#
# Note:
#	Canned Cycles not defined.
#
#
# Revisions
#
...
set mom_machine_name pm-002

   MOM_output_literal "$mom_sys_rewind_stop_code[string toupper <$mom_output_file_basename>,mxo,]"
...
#=============================================================
  ...
  if {$mom_spindle_speed <= 28} {
     set udc_spindle_range_code 41
  } elseif {$mom_spindle_speed > 28 && $mom_spindle_speed <= 56} {
     set udc_spindle_range_code 42
  } elseif {$mom_spindle_speed > 56 && $mom_spindle_speed <= 112} {
     set udc_spindle_range_code 43
  } elseif {$mom_spindle_speed > 112} {
     set udc_spindle_range_code 44
  }
