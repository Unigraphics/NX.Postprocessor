...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_adjust_code                       "10" 
  set mom_sys_adjust_code_minus                 "44" 
  set mom_sys_adjust_cancel_code                "11" 
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_y_axis_limit                      "15" 
  set mom_kin_z_axis_limit                      "6"  
...
#=============================================================
  global cycle_init_flag
   ...
   MOM_force Once G_motion X Y Z R F
...
#=============================================================
  global cycle_init_flag
   ...
   MOM_force Once G_motion X Y Z R F K_cycle cycle_step
...
#  sequence when the maximum nc tape file length is reached.  Add the following 
#  line of code (without the #) to the PB_CMD_before_motion custom command.
...
#
   set mom_sys_max_tape_bytes  120000
   set mom_sys_min_tape_bytes  100000

#
#  This variable is used to control the delta move along the tool axis when 
#  breaking the tape.
#
   set mom_sys_automatic_retract_distance 	2.0

#
#  This variable is used to define how close the reengage distance gets to 
#  the previous point.
#
   set mom_sys_automatic_reengage_distance 	.5
...
#
 ...
 if { [info exists present_time] }  {MOM_output_literal "( Operation Cutting Time: [ format %3.1f [ expr $mom_machine_time - $present_time]] min )"}

 set present_time $mom_machine_time

 MOM_output_literal "( Total Accumulated Time: [format %3.1f $mom_machine_time] min )"
...
#   if { [file exists $fn] == "1" } { MOM_remove_file $fn }
   ...
   set ptp_file_name "${mom_output_file_directory}${mom_output_file_basename}-$unique_file_id.${mom_sys_output_file_suffix}"
...
if { [info exists unique_file_id] } {
	MOM_output_literal "($unique_file_id)"
} else {
	set unique_file_id 1
	MOM_output_literal "($unique_file_id)"
}
MOM_set_seq_on
