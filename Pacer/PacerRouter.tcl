...
#  PacerRouter.tcl -
#
#  Created by jscott  @  Mon Feb 11 08:12:48 2008 GMT Standard Time
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_mod {G_motion rapid1 rapid2 rapid3}
...
proc PB_CMD_headers { } {
#=============================================================
# called from start of program

MOM_output_to_listing_device "( UNSUPPORTED POSTPROCESSOR FOR PACER ROUTER ) "

MOM_output_text "( UNSUPPORTED POSTPROCESSOR FOR PACER ROUTER ) "
}
...
#     
  ...
  MOM_force once G_motion X Y Z
  MOM_do_template linear_move_fast
}
...
#=============================================================
# called from start of program - redefines procs
...
#=============================================================
# no-op called from start of program - no-op

# written from example tape 

# Pacer router
# I&J incremental from start of arc
# no feeds
# instantaneous T
# Spindle speed but no M3/4 - not restated after tchange
# restates XYZIJ on each line

# G00 treated as not modal G02 treated as non modal
# end prog M02

# not supporting this bit :
# bizzarre G01 on dedicated block before first G01 departure after rapid
# but G01 is not treated as modal, subsequent G01 restated
#
}
