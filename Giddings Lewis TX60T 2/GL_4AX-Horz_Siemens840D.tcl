...
#
#  Created by marks  @  Tue Sep 16 13:17:22 2008 Eastern Daylight Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_cycle_bore_back_code              "80" 
  ...
  set mom_sys_coolant_code(ON)                  "7"  
  set mom_sys_coolant_code(FLOOD)               "7"  
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_5th_axis_max_limit                "120"
  set mom_kin_5th_axis_min_incr                 "0.001"
  set mom_kin_5th_axis_min_limit                "-120"
  ...
  set mom_kin_x_axis_limit                      "141"
  set mom_kin_y_axis_limit                      "98" 
  set mom_kin_z_axis_limit                      "60" 
...
#=============================================================
  global cycle_init_flag
   ...
   PB_CMD_SIEMENS_cycle_processor
...
proc MOM_cycle_off { } {
#=============================================================
   MOM_do_template cycle_mcall
   PB_CMD_SIEMENS_reset_count_holes_used
}
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_traverse_blk {G_feed G_motion X Y Z fourth_axis D}
...
#=============================================================
proc PB_CMD_SIEMENS_cancel_csys_output { } {
#=============================================================
...
global csys_flag
 ...
 if {$mom_kin_coordinate_system_type == "CSYS"} {
      if { $csys_flag == 1 } {
          #MOM_output_literal ";(CANCEL CSYS OUTPUT)"
...
#=============================================================
proc PB_CMD_SIEMENS_coolant_output { } {
#=============================================================
# Output coolant codes

global mom_coolant_mode
global mom_coolant_status
global mom_coolant_m7
global mom_coolant_m8
global mom_coolant_m50
global mom_coolant_m51
global mom_coolant_m52
global mom_coolant_m53
global mom_coolant_m54
global mom_coolant_m55
global mom_coolant_m56
global mom_coolant_m57
global mom_coolant_m58
global mom_coolant_m59
global M7_flag
global M8_flag
global M50_flag
global M51_flag
...
if {$mom_coolant_m7 == "TRUE" && $M7_flag == "OFF"} {
    MOM_output_literal "M7"
    set M7_flag "ON"
}
if {$mom_coolant_m8 == "TRUE" && $M8_flag == "OFF"} {
    MOM_output_literal "M8"
    set M8_flag "ON"
}
if {$mom_coolant_m50 == "TRUE" && $M50_flag == "OFF"} {
    MOM_output_literal "M50"
    set M50_flag "ON"
}
if {$mom_coolant_m51 == "TRUE" && $M51_flag == "OFF"} {
    MOM_output_literal "M51"
    set M51_flag "ON"
}
if {$mom_coolant_m52 == "TRUE" && $M52_flag == "OFF"} {
    MOM_output_literal "M52"
    set M52_flag "ON"
}
if {$mom_coolant_m53 == "TRUE" && $M53_flag == "OFF"} {
    MOM_output_literal "M53"
    set M53_flag "ON"
}
if {$mom_coolant_m54 == "TRUE" && $M54_flag == "OFF"} {
    MOM_output_literal "M54"
    set M54_flag "ON"
}
if {$mom_coolant_m55 == "TRUE" && $M55_flag == "OFF"} {
    MOM_output_literal "M55"
    set M55_flag "ON"
}
if {$mom_coolant_m56 == "TRUE" && $M56_flag == "OFF"} {
    MOM_output_literal "M56"
    set M56_flag "ON"
}
if {$mom_coolant_m57 == "TRUE" && $M57_flag == "OFF"} {
    MOM_output_literal "M57"
    set M57_flag "ON"
}
if {$mom_coolant_m58 == "TRUE" && $M58_flag == "OFF"} {
    MOM_output_literal "M58"
    set M58_flag "ON"
}
if {$mom_coolant_m59 == "TRUE" && $M59_flag == "OFF"} {
    MOM_output_literal "M59"
    set M59_flag "ON"
}
...
#=============================================================
proc PB_CMD_SIEMENS_coolant_reset { } {
#=============================================================
global mom_coolant_m7
global mom_coolant_m8
global mom_coolant_m50
...
set mom_coolant_m7 "FALSE"
set mom_coolant_m8 "FALSE"
set mom_coolant_m50 "FALSE"
set mom_coolant_m51 "FALSE"
set mom_coolant_m52 "FALSE"
set mom_coolant_m53 "FALSE"
set mom_coolant_m54 "FALSE"
set mom_coolant_m55 "FALSE"
set mom_coolant_m56 "FALSE"
set mom_coolant_m57 "FALSE"
set mom_coolant_m58 "FALSE"
set mom_coolant_m59 "FALSE"
set M7_flag "OFF"
set M8_flag "OFF"
set M50_flag "OFF"
set M51_flag "OFF"
...
#=============================================================
proc PB_CMD_SIEMENS_csys_rotate_output { } {
#=============================================================

  global mom_kin_coordinate_system_type
  global csys_record_1 
  global csys_record_2
  global csys_flag
  global mom_rotation_angle

  global mom_out_angle_pos
  global saved_out_angle_pos_C
  global saved_out_angle_pos_A

  set local_C_axis_output "YES"

  if {$mom_kin_coordinate_system_type == "CSYS"} {

      if { [info exists mom_rotation_angle] } {

          # MOM_output_literal "MOM ROTATION ANGLE UDE EXISTS= $mom_rotation_angle"

          if { ![EQ_is_equal $mom_rotation_angle $saved_out_angle_pos_C] } {
              set saved_out_angle_pos_C $mom_rotation_angle
              set local_C_axis_output "NO"
          } 
      } else {
              set local_C_axis_output "YES"
      }

      if { [info exists csys_record_1] && [info exists csys_record_2] } {

          set mom_out_angle_pos(0) $saved_out_angle_pos_C
          set mom_out_angle_pos(1) $saved_out_angle_pos_A

          if { $local_C_axis_output == "YES" } {
              PB_CMD_fourth_axis_rotate_move
          }

          PB_CMD_fifth_axis_rotate_move

          MOM_output_literal $csys_record_1
          MOM_output_literal $csys_record_2

          MOM_force once G_mode G_motion G X Y Z F

          set csys_flag 1

          # 3-Axis 0,0,1 IJK Mode  Negate A C output dual head
          MOM_suppress always fourth_axis fifth_axis
      }

  } else {
    # LOCAL MAIN MCS MASTER
     MOM_force once G_mode G_motion G X Y Z F fourth_axis fifth_axis
  }
}


#=============================================================
proc PB_CMD_SIEMENS_cycle_call { } {
#=============================================================

global feed
global spindle_dir_code
global mom_motion_event
global siemens_cycle_number
global tap_pitch_value
...
global mom_cycle_delay
  ...
  #set mom_sys_cycle_bore_manual_code            "87" 
  #set mom_sys_cycle_bore_manual_dwell_code      "88" 
  #set mom_sys_cycle_bore_back_code              "" 
...
if { [info exists mom_spindle_direction] } {
    if {$mom_spindle_direction == "CLW"} {
        set spindle_dir_code 3
    } elseif {$mom_spindle_direction == "CCLW"} {
        set spindle_dir_code 4
    } elseif {$mom_spindle_direction == "OFF"} {
        set spindle_dir_code 5
    }
} else {
    set spindle_dir_code 3
}
...
switch $mom_motion_event {
  ...
  drill_move {
      set siemens_cycle_number $mom_sys_cycle_drill_code
      MOM_do_template siemens_cycle_drill
  }

  drill_dwell_move {
      set siemens_cycle_number $mom_sys_cycle_drill_dwell_code
      MOM_do_template siemens_cycle_drill_dwell
  }

  drill_deep_move {
      set siemens_cycle_number $mom_sys_cycle_drill_deep_code
      MOM_do_template siemens_cycle_drill_deep
  }

  drill_break_chip_move {
      set siemens_cycle_number $mom_sys_cycle_drill_break_chip_code
      MOM_do_template siemens_cycle_drill_break_chip
  }

  tap_move {
      set siemens_cycle_number $mom_sys_cycle_tap_code
      set tap_pitch_value [expr 1.0 / ($mom_spindle_speed / $mom_cycle_feed_rate)]
      MOM_do_template siemens_cycle_tap
  }

  bore_move {
      set siemens_cycle_number $mom_sys_cycle_bore_code
      MOM_do_template siemens_cycle_bore
  }

  bore_dwell_move {
      set siemens_cycle_number $mom_sys_cycle_bore_dwell_code
      MOM_do_template siemens_cycle_bore_dwell
  }

  bore_drag_move {
      set siemens_cycle_number $mom_sys_cycle_bore_drag_code
      MOM_do_template siemens_cycle_bore_drag
  }

  bore_no_drag_move {
      set siemens_cycle_number $mom_sys_cycle_bore_no_drag_code
      MOM_do_template siemens_cycle_bore_no_drag
  }

  bore_manual_move {
      set siemens_cycle_number $mom_sys_cycle_bore_manual_code
      MOM_do_template siemens_cycle_bore_manual
  }

  bore_manual_dwell_move {
      set siemens_cycle_number $mom_sys_cycle_bore_manual_dwell_code
      MOM_do_template siemens_cycle_bore_manual_dwell
  }
}
}
...
#=============================================================
proc PB_CMD_SIEMENS_cycle_error { } {
#=============================================================
MOM_output_literal "<<< ERROR: Cycle not defined >>>"
}


#=============================================================
proc PB_CMD_SIEMENS_cycle_processor { } {
#=============================================================
#PB_CMD_SIEMENS_cycle_processor

global count_holes_used

if { $count_holes_used == 0 } {
    PB_CMD_SIEMENS_cycle_call
    MOM_force once X Y F
}

MOM_do_template siemens_cycle_xyz_move

incr count_holes_used
}


#=============================================================
proc PB_CMD_SIEMENS_cycle_processor_bobs { } {
#=============================================================
...
if { ![EQ_is_equal $mom_out_angle_pos(1) 0.0] } {

    # MOM_output_literal "COUNT HOLES USED= $count_holes_used"

    if { $count_holes_used == 0 } {
        # MOM_output_literal "A 5TH AXIS TRAPPED"
        # MOM_output_literal "PREV X mom_prev_pos(0)= $mom_prev_pos(0)"
        # MOM_output_literal "CURRENT X mom_pos(0)= $mom_pos(0)"

        MOM_force once X Y Z

        # Drop down to the RAPTO R-Plane
        MOM_do_template siemens_cycle_xyz_move

        MOM_force once X Y Z F fourth_axis fifth_axis
        MOM_do_template siemens_cycle_trans_coords
        MOM_do_template siemens_arot_coords
        MOM_do_template cycle_g1_feed

        PB_CMD_SIEMENS_execute_cycle_motion
        #MOM_output_literal "HIT 1"

    } else {

        MOM_output_literal "TRAORI"
        MOM_force once G_feed G_motion G_mode G X Y Z fourth_axis fifth_axis
        MOM_do_template rapid_traverse
        MOM_force once G X Y Z F fourth_axis fifth_axis
        MOM_force once X Y Z
        MOM_do_template siemens_cycle_xyz_move
        ...
        MOM_do_template cycle_g1_feed 
        PB_CMD_SIEMENS_execute_cycle_motion
        #MOM_output_literal "HIT 2"
    }

} else {

  # MOM_output_literal "A 5TH AXIS is ZERO - DO NOT TRANS with AROT"
  ...
  if { $count_holes_used == 0 } {
      ...
      PB_CMD_SIEMENS_execute_cycle_motion
      #MOM_output_literal "HIT 3"

  } else {
      MOM_do_template siemens_cycle_xyz_move
      PB_CMD_SIEMENS_execute_cycle_motion
      #MOM_output_literal "HIT 4"
  }
}
...
#=============================================================
proc PB_CMD_SIEMENS_cycle_processor_bobs_new { } {
#=============================================================
...
#=============================================================
proc PB_CMD_SIEMENS_reset_count_holes_used { } {
#=============================================================
global count_holes_used
set count_holes_used 0
...
#=============================================================
proc PB_CMD_Z_TCH_POS { } {
#=============================================================
MOM_output_literal "D0 G500 G94 G90 G0 Z=TCH_POS_Z"
MOM_output_literal "MCHA"
MOM_output_literal "WAITE(2)"
}
...
return
  ...
  #*************************
   ...
   set cam_custom_dir   [MOM_ask_env_var UGII_CAM_CUSTOM_DIR]
...
return
  ...
  #------------------
   ...
   MOM_output_text "$co             T O O L   L I S T                        $ci"
   MOM_output_text "$co======================================================$ci"
   MOM_output_text "$co  STATION  OFFSET       DESCRIPTION                   $ci"
   MOM_output_text "$co======================================================$ci"
  ...
  #------------------
   ...
   foreach tool $tool_list {
     ...
     #       MOM_output_text "$tool_data_buffer($tool_type,header)"
     #    }
     # }

      if [info exists tool_data_buffer($tool,output)] {
         MOM_output_text "$tool_data_buffer($tool,output)"
      }
  ...
  #------------------
   ...
   MOM_output_literal "G710"
   MOM_output_literal "G64"
   MOM_output_literal "PGSTR"
   MOM_output_literal "$co DESCRIPTION= USING TOOLS"
   MOM_output_literal "$co RUN-TIME= 00-00-00"
   MOM_output_literal "$co CUT-TIME= 00-00-00"
   MOM_output_literal "$co SECURITY-CLASS= 2"
   MOM_output_literal "$co PROGRAM-TYPE= 0"
   MOM_output_literal "$co PROGRAM-CLASS= 0"
   MOM_output_literal "$co T-START"

   foreach tool $tool_list {
      if [info exists tool_data_buffer($tool,output2)] {
         MOM_output_literal "$tool_data_buffer($tool,output2)"
      }
      set prev_tool_type $tool_type
   }
   MOM_output_literal "$co T-END"
...
#=============================================================
proc PB_CMD_custom_header { } {
#=============================================================
# CAT Custom CAT PARTNO/ procedure

proc MOM_cat_partno {} {

  global mom_cat_pn_facility_code
  global mom_cat_pn_division
  global mom_cat_pn_part_number
  global mom_cat_pn_engr_version_code
  global mom_cat_pn_oper_number
  global mom_cat_pn_method_seq
  global mom_cat_pn_machine_seq
  global mom_cat_pn_machine_number
  global mom_cat_pn_engr_change_level
  global mom_cat_pn_tmp_dwg_change_level
  global mom_cat_pn_mfg_revision
  global mom_cat_pn_mfg_change_level_suffix
  global mom_cat_pn_layout_change_level
  global mom_cat_pn_prog_rev_level
  global mom_cat_pn_layout_id_number
  global mom_cat_pn_user_area
  global mom_command_status


  if { $mom_command_status == "ACTIVE" } {

    # FIELD 1 Facility Code Parse out last 2 digits from choose menu

    set lth1 [string length $mom_cat_pn_facility_code]
    set lth1 [expr $lth1 - 2]
    set pn1 [string range $mom_cat_pn_facility_code $lth1 end]
    set partno_all $pn1

    # FIELD 2  Division Number  3 Numeric Digits Leading Zeroes

    set pn2 $mom_cat_pn_division
    set col_zeroes 3
    set tmp [string length $pn2]
    for {set ii $tmp} {$ii < $col_zeroes} {incr ii} {
      set pn2 0$pn2
    }
    set partno_all $partno_all$pn2
    # MOM_output_literal "PARTNO$partno_all"

    # FIELD 3  Part Number 8 Characters Fixed Field Alpha-Numeric

    set pn3 [string toupper $mom_cat_pn_part_number]

    # Test for User Input over 8 Characters - If True- Inform User and Abort Posting
    set lth3 [string length $pn3]

    if {$lth3 > 8} {
      MOM_output_to_listing_device  "* * * * * * * * * * * * * * * *  WARNING  * * * * * * * * * * * * * * * *" 
      MOM_output_to_listing_device  "* * * *                 PARTNO Entry Field ERROR         * * * *"
      MOM_output_to_listing_device  "* * PART NUMBER Entry:  $pn3   Exceeds 8 Alpha-Numeric Characters * *"
      MOM_output_to_listing_device " "  
      MOM_output_to_listing_device  "* * * *   Post-Processing to Create CLS File Aborted !!!  * * * *"
      MOM_output_to_listing_device  "* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *"
      MOM_output_to_listing_device " "
      MOM_abort "Post Process to CLS File Terminated- See Listing Device Window"
    }
    set col_zeroes 8
    set tmp [string length $pn3]
    for {set ii $tmp} {$ii < $col_zeroes} {incr ii} {
      set pn3 0$pn3
    }

    # Add a blank between pn2 and pn3
    set partno_all "$partno_all $pn3"
    # MOM_output_literal "PARTNO$partno_all"

  # FIELD 4 Optional Engr. Version Code  2 Char Strings A-Z

  # Test for User Input over 2 Characters - If True- Inform User and Abort Posting
  set lth4 [string length $mom_cat_pn_engr_version_code]

  if {$lth4 > 2} {
    MOM_output_to_listing_device  " * * * * * * * * * * * * * * * * WARNING * * * * * * * * * * * * * * * *" 
    MOM_output_to_listing_device  "* * * *                 PARTNO Entry Field ERROR          * * * *"
    MOM_output_to_listing_device  "  **** ENGR. DWG. VERSION CODE Entry:  $mom_cat_pn_engr_version_code   Exceeds 2 Alpha Characters  Limit *****"
    MOM_output_to_listing_device " "  
    MOM_output_to_listing_device  "* * * *   Post-Processing to Create CLS File Aborted !!!  * * * *"
    MOM_output_to_listing_device  " * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *"
    MOM_output_to_listing_device " "
  ...
  if {$mom_cat_pn_engr_version_code == "" } {
    set pn4 "  "
  } else {
    set pn4 [string toupper $mom_cat_pn_engr_version_code]
    set col_zeroes 2
    set tmp [string length $pn4]
    for {set ii $tmp} {$ii < $col_zeroes} {incr ii} {
      set pn4 " $pn4" ; # Leading Blank if only 1 Character long
    }
  }
  set partno_all $partno_all$pn4
  # MOM_output_literal "PARTNO$partno_all"

  # FIELD 5 Part No. Operation Number 3 Digit  Numeric Leading Zeroes

  set pn5 $mom_cat_pn_oper_number
  set col_zeroes 3
  set tmp [string length $pn5]
  for {set ii $tmp} {$ii < $col_zeroes} {incr ii} {
    set pn5 0$pn5
  }

  # Add a blank between pn4 and pn5
  set partno_all "$partno_all $pn5"
  # MOM_output_literal "PARTNO$partno_all"
 
  # FIELD 6 Method Sequence  Numeric 1-9  If zero- output blank space

  set pn6 $mom_cat_pn_method_seq
  if {$pn6 == 0} {
    set pn6 " "
  } 

  # Add a blank between pn5 and pn6
  set partno_all "$partno_all $pn6"
  # MOM_output_literal "PARTNO$partno_all"

  # FIELD 7 Machine Sequence  Numeric 1-9  If zero- output blank space

  set pn7 $mom_cat_pn_machine_seq
  if {$pn7 == 0} {
    set pn7 " "
  } 

  set partno_all $partno_all$pn7
  # MOM_output_literal "PARTNO$partno_all"

  # FIELD ? Machine Designation not used  1 Alpha Character or Blank
  # cat_pn_machine_type

  # FIELD 8 Machine Number  6 Numeric Digits using Leading Zeroes

  set pn8 $mom_cat_pn_machine_number
  set col_zeroes 6
  set tmp [string length $pn8]
  for {set ii $tmp} {$ii < $col_zeroes} {incr ii} {
    set pn8 0$pn8
  }

  # Add a blank between pn7 and pn8
  set partno_all "$partno_all $pn8"
  # MOM_output_literal "PARTNO$partno_all"

  # FIELD 9 Engineering Change Level 2 Numeric Digits with Leading Zeroes

  set pn9 $mom_cat_pn_engr_change_level
  set col_zeroes 2
  set tmp [string length $pn9]
  for {set ii $tmp} {$ii < $col_zeroes} {incr ii} {
    set pn9 0$pn9
  }

  # Add a blank between pn8 and pn9
  set partno_all "$partno_all $pn9"
  # MOM_output_literal "PARTNO$partno_all"

  # FIELD 10 Engineering Temporary Drawing Change Level  Numeric 1-9  If zero- output blank space 

  set pn10 $mom_cat_pn_tmp_dwg_change_level
  if {$pn10 == 0} {
    set pn10 " "
  } 
  set partno_all $partno_all$pn10
  # MOM_output_literal "PARTNO$partno_all"

  # FIELD 11 Mfg Change Level  2 Digits with Leading Zeroes

  set pn11 $mom_cat_pn_mfg_revision
  set col_zeroes 2
  set tmp [string length $pn11]
  for {set ii $tmp} {$ii < $col_zeroes} {incr ii} {
    set pn11 0$pn11
  }
  set partno_all $partno_all$pn11
  # MOM_output_literal "PARTNO$partno_all"

  # FIELD 12  Mfg. Change Level Suffix   1 Alpha Character or Blank

  if {$mom_cat_pn_mfg_change_level_suffix == "" } {
    set pn12 " "  ; # 1 Blank Space
  } else {
    set pn12 [string toupper $mom_cat_pn_mfg_change_level_suffix]
  }
  set partno_all $partno_all$pn12
  # MOM_output_literal "PARTNO$partno_all"

  # FIELD 13  Layout Change Level   1 Alpha Character or Blank

  if {$mom_cat_pn_layout_change_level == "" } {
    set pn13 " "  ; # 1 Blank Space
  } else {
    set pn13 [string toupper $mom_cat_pn_layout_change_level]
  }
  set partno_all $partno_all$pn13
  # MOM_output_literal "PARTNO$partno_all"

  # FIELD 14  Program Revision Level   1 Alpha Character or Blank

  if {$mom_cat_pn_prog_rev_level == "" } {
    set pn14 " "  ; # 1 Blank Space
  } else {
    set pn14 [string toupper $mom_cat_pn_prog_rev_level]
  }
  set partno_all $partno_all$pn14
  # MOM_output_literal "PARTNO$partno_all"

  # FIELD 15 Layout and/or Program Identification  7 Digits with Leading Zeroes

  set pn15 $mom_cat_pn_layout_id_number
  set col_zeroes 7
  set tmp [string length $pn15]
  for {set ii $tmp} {$ii < $col_zeroes} {incr ii} {
    set pn15 0$pn15
  }
  set partno_all $partno_all$pn15
  # MOM_output_literal "PARTNO$partno_all"

  # FIELD 16  User Area  Alpha-Numeric 20 Characters Max.

  if {$mom_cat_pn_user_area == "" } {
    set pn16 ""
  } else {
    set pn16 [string toupper $mom_cat_pn_user_area]
    set pn16 " $pn16"
  }
  # Allow 20 Characters Max.
  set pn16 [string range $pn16 0 19]
  set partno_all $partno_all$pn16

  # Output program/layout name
  set cat_layout_no_start ";%_N_"
  set cat_layout_no_end "_MPF"
  MOM_output_text "$cat_layout_no_start$pn15$cat_layout_no_end"

  # The following is actual output of the constructed PARTNO/   All previous are for testing only
  MOM_output_text "MSG (\"$partno_all\")"
  }
  # End of "active" command status
}
# End of proc MOM_cat_partno
}
...
#=============================================================
proc PB_CMD_gohome_force_rotary_A0_C0_neutral { } {
#=============================================================
...
if {$mom_motion_type == "GOHOME" } {

## Output the original intended GOHOME move with accounting for MCS type

#MOM_output_literal ";(GOHOME END OF PATH IN USE -- MCS= $mom_kin_coordinate_system_type)"
...
# Reset UGPost to Neuutral state so C-Axis Rotate always honored

set mom_prev_pos(3) 0.0 ; # 4th C-Axis - about Z
set mom_prev_pos(4) 0.0 ; # 5th A-Axis YZ Plane

set mom_pos(3) 0.0 ; # 4th C-Axis - about Z
set mom_pos(4) 0.0 ; # 5th A-Axis YZ Plane

set mom_out_angle_pos(0) 0.0 ; # 4th C-Axis - about Z
set mom_out_angle_pos(1) 0.0 ; # 5th A-Axis YZ Plane
...
# MOM_output_literal "HIT RE-LOADED GOHOME MOVE mom_motion_type= $mom_motion_type"
...
#=============================================================
proc PB_CMD_init_procs { } {
#=============================================================
uplevel #0 {
    PB_CMD_custom_header
    PB_CMD_op_message
}
# End uplevel

PB_CMD_init_helix
PB_CMD_init_spf_holes
PB_CMD_init_prosin
PB_CMD_init_work_offset
}


#=============================================================
proc PB_CMD_init_prosin { } {
#=============================================================
# UDE for CAT PROSIN Tool Monitoring 

uplevel #0 {
    proc MOM_cat_prosin {} {
        global mom_cat_prosin_type
        global mom_cat_prosin_spf
        global mom_cat_prosin_id_number

        if {$mom_cat_prosin_type == "LOAD"} {
            MOM_output_literal "PROSIN_LOAD(\"$mom_cat_prosin_spf\")"
            MOM_output_literal "$mom_cat_prosin_spf"
            MOM_output_literal "PROSIN_SWITCH=$mom_cat_prosin_id_number"
        } elseif {$mom_cat_prosin_type == "ACT"} {
            MOM_output_literal "PROSIN_ACT($mom_cat_prosin_id_number)"
        } else {
            MOM_output_literal "PROSIN_END"
        }
    }
}
# End uplevel
...
#=============================================================
proc PB_CMD_init_spf_holes { } {
#=============================================================
# UDE for CAT SPF hole programs

uplevel #0 {
    proc MOM_cat_spf_holes {} {
        global mom_cat_spf_type
        global mom_cat_spf_id_number
        global mom_cat_spf_dir

        set us "_"

        MOM_output_literal "$mom_cat_spf_type$us$mom_cat_spf_id_number$us$mom_cat_spf_dir"
    }
}
# End uplevel
}
...
return
  ...
  #*************************************************
   ...
   switch $tool_type {
      ...
      "MILL" {
         ...
         set output [format "%-3s %-8d %-8d %-20s"  $start_line $mom_tool_number $mom_tool_length_adjust_register $mom_tool_name] 
         set output2 " T$mom_tool_number $co $ttime" 
      }
  ...
  #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   set tool_data_buffer($mom_tool_name,output) "$co$output$ci"
   set tool_data_buffer($mom_tool_name,type)   "$tool_type"
   set tool_data_buffer($mom_tool_name,output2) "$co$output2$ci"
}
...
proc MOM_SETUP_HDR {} {
  ...
  # Label title for tool time only when it exists.
   ...
   if [info exists mom_sys_tool_time] {
     ...
     set output [format "%-10s %-10s %-20s" $tool_number $adjust $tool_desc] 
...
proc MAP_TOOL_TYPE { } {
   ...
   if {[string match "Milling*" $mom_tool_type]} {
      return "MILL"
   } elseif { [string match "Thread Mill*" $mom_tool_type]} {
      return "MILL"
...
global first_op_flag
set first_op_flag "YES"
...
#=============================================================
proc PB_CMD_init_work_offset { } {
#=============================================================
# UDE for CAT Work Offset Assignment

uplevel #0 {
    proc MOM_cat_work_offset {} {
        global mom_cat_woa_id_number
        global mom_cat_woa_x
        global mom_cat_woa_y
        global mom_cat_woa_z
        global mom_cat_woa_text
        global p_uifr

        if {$mom_cat_woa_id_number >= 54 && $mom_cat_woa_id_number <= 57} {
            set p_uifr [expr $mom_cat_woa_id_number - 53]
        } elseif {$mom_cat_woa_id_number >= 505 && $mom_cat_woa_id_number <= 599} {
            set p_uifr [expr $mom_cat_woa_id_number - 500]
        } else {
            MOM_output_literal ">>> ERROR: Invalid work offset. <<< "
            set p_uifr 0
        }
        MOM_set_seq_off
        MOM_do_template work_offset_ude_msg
        MOM_set_seq_on
        MOM_do_template work_offset_ude_ctrans
    }
}
# End uplevel
}
...
MOM_do_template work_offset
MOM_do_template spindle_rpm

MOM_force once G_motion X Y Z fourth_axis F
MOM_do_template move_initial_xy
MOM_do_template move_initial_z

PB_CMD_SIEMENS_coolant_output
}


#=============================================================
proc PB_CMD_move_initial { } {
#=============================================================
global mom_cutcom_plane
global mom_pos_arc_plane
...
#=============================================================
proc PB_CMD_no_pgm_nbr_abort { } {
#=============================================================
global mom_program_nbr
       
    if {[info exists mom_program_nbr]} {
        return
       } else {
       MOM_output_to_listing_device  " *********************************************************"
       MOM_output_to_listing_device  "  Program Number UDE Not Set in Program Group "
       MOM_output_to_listing_device  "  Post Processing is Aborted"
       MOM_output_to_listing_device  " *********************************************************"
       MOM_abort " Program Number UDE Not Set - UGPosting Aborted"       
       }
}
...
#_______________________________________________________________________________
         ...
         if {$mom_operator_message != "ON" && $mom_operator_message != "OFF"} {
             ...
             if {$brac_end == -1 ||  $brac_end != [expr [string length $mom_operator_message] -1 ]} {
               append text_string ")"
             }
             ...
             #MOM_output_literal $text_string
             MOM_output_text "MSG $text_string"
...
#=============================================================
proc PB_CMD_output_TCH { } {
#=============================================================
MOM_output_literal "TCH"
}


#=============================================================
proc PB_CMD_output_TRAFOOF { } {
#=============================================================
...
#=============================================================
proc PB_CMD_output_Tool_Breakage { } {
#=============================================================
MOM_output_literal "TOOL_BREAKAGE_CONTROL_ENABLE=0"
}


#=============================================================
proc PB_CMD_output_WAITE { } {
#=============================================================
MOM_output_literal "WAITE(2)"
}
...
if { $mom_next_oper_has_tool_change == "YES" && $first_tool_flag == "NO"} {
    set tchg_flag "YES"
    PB_CMD_SIEMENS_coolant_reset
    MOM_do_template coolant_off
    MOM_do_template spindle_off
...
if {$first_op_flag == "YES"} {
    PB_CMD_create_tool_list
    set first_op_flag "NO"
}
  
if { $tchg_flag != "YES" } {
    MOM_output_text "MSG (\"$mom_operation_name\")"
}
}
...
#=============================================================
proc PB_CMD_prog_end { } {
#=============================================================
MOM_do_template coolant_off
MOM_do_template spindle_off
MOM_output_literal "G53"
MOM_do_template tool_tchg_prog_end
MOM_do_template tool_lock
MOM_output_literal "WORK_DONE"
MOM_do_template program_end
MOM_set_seq_off
...
#=============================================================
proc PB_CMD_set_arc_plane { } {
#=============================================================
global mom_pos_arc_plane

#MOM_output_text "ARC PLANE= $mom_pos_arc_plane"
MOM_do_template plane_arc

if {$mom_pos_arc_plane == "YZ"} {
  MOM_force once G_motion Y Z J K
} elseif {$mom_pos_arc_plane == "ZX"} {
  MOM_force once G_motion X Z I K
} elseif {$mom_pos_arc_plane == "XY"} {
...
########### Spitz Hayes 10/04/2005
## Siemens specific only -- original deleted
...
##########
  ...
  set saved_out_angle_pos_C $mom_out_angle_pos(0)
  set saved_out_angle_pos_A $mom_out_angle_pos(1)
 ...
 # PB_CMD_fifth_axis_rotate_move
  ...
  global csys_record_2
   ...
   #  MOM_output_literal "TRANS X$X Y$Y Z$Z"
    set csys_record_1 "TRANS X$X Y$Y Z$Z"
    ...
    if { $csys_flag == 1 } {
      ...
      # set csys_flag 1  SET LATER AT ACTUAL OUTPUT TIMING
...
#=============================================================
proc PB_CMD_start_of_operation_address_outputs { } {
#=============================================================

global mom_kin_coordinate_system_type

 if {$mom_kin_coordinate_system_type == "CSYS"} {
   # 3-Axis Mode XYZ Only
      #MOM_force once G_mode G_motion S M_spindle X Y Z F
      MOM_force once G_feed G_mode G_motion G X Y Z F

 } else {
  # Local MAIN MCS MASTER Full 5-Axis
      #MOM_force once G_mode G_motion S M_spindle X Y Z F fourth_axis fifth_axis
      MOM_force once G_feed G_mode G_motion G X Y Z F fourth_axis fifth_axis
 }
}
...
if {![info exists mom_tool_length_adjust_register]} {
    set mom_tool_length_adjust_register 0
}

MOM_output_text "MSG (\"TOOL NAME: $mom_tool_name\")"
MOM_output_text "MSG (\"     POSITION: $mom_tool_number\")"
MOM_output_text "MSG (\"     OFFSET: $mom_tool_adjust_register\")"
MOM_output_text "MSG (\"     DIAMETER: [format %-8.4f $mom_tool_diameter]\")"
MOM_output_text "MSG (\"$mom_operation_name\")"

MOM_do_template tool_tchg
MOM_do_template tool_lock
MOM_do_template tool_next
...
#=============================================================
proc PB_CMD_ude_program_number { } {
#=============================================================

#=============================================================
#
# This uplevel will output the program ID number.
#

uplevel #0 {

    proc MOM_program_number {} { 

    global mom_program_nbr
    global mom_part_nbr
    global mom_wc_nbr
    global mom_mach_name
    global mom_prgmr_name
    global mom_date
    global program_flag_used
...
#    MOM_set_seq_off
#    MOM_do_template rewind_stop_code
#    MOM_output_literal "O$mom_program_nbr"
    MOM_set_seq_on
    MOM_output_literal "( Part Number: $mom_part_nbr )"
    MOM_output_literal "( Machine: $mom_wc_nbr $mom_mach_name )"
    MOM_output_literal "( Programmer: $mom_prgmr_name )"
    MOM_output_literal "( Date: $month-$day-$year )"
    
    
    set program_flag_used 1
    }
  }
}
}
