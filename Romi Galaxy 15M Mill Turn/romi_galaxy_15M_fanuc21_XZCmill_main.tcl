########################## TCL Event Handlers ##########################
#
#  Created by kleber.ronconi  @  Tue Aug 31 10:48:44 2004 E. South America Daylight Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_home_pos(0)                       "400"
  set mom_sys_home_pos(1)                       "0"  
  set mom_sys_home_pos(2)                       "250"
  set mom_sys_zero                              "0"  
  ...
  set mom_sys_lathe_postname                    "romi_galaxy_15M_fanuc21_lathe"
...
#=========================
 ...
 set mom_sys_master_head                       "SPINDLE_AXIS_Z"

 set mom_sys_postname(SPINDLE_AXIS_Z)          "$mom_sys_master_post"
 set mom_sys_postname(SPINDLE_AXIS_X)          "romi_galaxy_15M_fanuc21_XZCmill_Xspindle"
 set mom_sys_postname(TURN)                    "romi_galaxy_15M_fanuc21_lathe"
...
#=============================================================
proc PB_start_of_HEAD__SPINDLE_AXIS_X { } {
#=============================================================
   PB_CMD_set_spindle_axis
   MOM_do_template start_of_HEAD__SPINDLE_AXIS_X_1
}


#=============================================================
proc PB_end_of_HEAD__SPINDLE_AXIS_X { } {
#=============================================================
   PB_CMD_unset_spindle_axis
   MOM_do_template end_of_HEAD__SPINDLE_AXIS_X_1
}
...
#=============================================================
   MOM_do_template end_of_HEAD__TURN
}
...
#=============================================================
   ...
   if { [info exists mom_sys_in_operation] && $mom_sys_in_operation == 1 } {
      set mom_warning_info "HEAD event should not be assigned to an operatrion."
      MOM_catch_warning
return
   }
   ...
   if { [info exists mom_head_name] } {
      ...
      set mom_warning_info "No head assigned"
      MOM_catch_warning
return
   }
   ...
   if { [info exists mom_sys_postname($NEXT_HEAD)] && \
        ![string match "$NEXT_HEAD" $CURRENT_HEAD] } {
      ...
      if [string match "$CURRENT_HEAD" $mom_sys_master_head] {
         ...
         if [file exists "$tcl_file"] {
            ...
            if [file exists "$tcl_file"] {
               ...
               set mom_warning_info  "Post $mom_sys_postname($CURRENT_HEAD) not found"
               MOM_catch_warning
            }
         }
      }
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_feed G_motion G_mode X Z M_coolant}
   set rapid_spindle_x_blk {G_feed G_motion G_mode X M_coolant}
   set rapid_spindle_y_blk {G_feed G_motion G_mode M_coolant}
   set rapid_spindle_z_blk {G_feed G_motion G_mode Z M_coolant}
   set rapid_traverse_blk {G_feed G_motion G_mode X Z fourth_axis S M_spindle}
   set rapid_traverse_xy_blk {G_feed G_motion G_mode X fourth_axis S M_spindle}
   set rapid_traverse_yz_blk {G_feed G_motion G_mode Z fourth_axis S M_spindle}
...
set tempo_anterior   0
 ...
 MOM_output_literal "$co MAQUINA  : TORNO ROMI GALAXY 15M - COMANDO: FANUC 21i $ci"
...
global co ci
global mom_cycle_spindle_axis mom_sys_spindle_axis

MOM_output_literal "$co $mom_cycle_spindle_axis $ci"
MOM_output_literal "$co MODO     : MILLING - SPINDLE AXIS Z $ci"
...
if [info exists mom_cycle_spindle_axis] { unset mom_cycle_spindle_axis }
set mom_cycle_spindle_axis	0
...
#=============================================================
proc PB_CMD_unset_spindle_axis { } {
#=============================================================
global mom_cycle_spindle_axis mom_sys_spindle_axis
