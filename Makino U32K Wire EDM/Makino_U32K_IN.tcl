...
#  Makino_U32K_IN.tcl -
#
#  Created by suyo  @  Thu Oct 25 17:45:26 2007 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_power_on                          "17" 
  set mom_sys_power_off                         "18" 
  set mom_sys_wire_on                           "6"  
  set mom_sys_wire_off                          "7"  
...
set M6_output 0
MOM_force Once machining_status
...
#=============================================================
proc PB_CMD_M7_output { } {
#=============================================================
global m06_m17_output
global m07_output

if { $m07_output == 1 } {
   MOM_output_literal "M07"
   set m06_m17_output 1
   set m07_output 0
}
...
#=============================================================
proc PB_CMD_output_E_D { } {
#=============================================================
global first_E_D

if { [info exists first_E_D] } {

    if { $first_E_D == 1 } {
   MOM_output_literal "E1056 D681"
   set first_E_D 0
     }
  }
}
