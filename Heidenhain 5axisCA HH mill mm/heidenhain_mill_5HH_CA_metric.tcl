########################## TCL Event Handlers ##########################
#
#  Created by maozhi  @  Thu Apr 21 07:58:09 2005 China Standard Time
...
#
   if { $mom_kin_iks_usage == 1 } {
      ...
      set mom_kin_5th_axis_vector(0)      1.0
...
#***************************
 set user_tcl_file ${cam_post_dir}heidenhain_mill_5HH_AB_metric_user.tcl
