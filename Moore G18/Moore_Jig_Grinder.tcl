...
#
#  Created by marekj  @  Mon Jan 12 11:30:53 2009 Eastern Daylight Time
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_rapid_feed_rate                   "20" 
...
#=============================================================
   PB_CMD_reset_caxis_dir
   MOM_force Once G C_axis
   MOM_do_template reset_c_axis
...
global caxis_dir
global caxis_angle
global prev_caxis_angle

set caxis_dir "C"
set caxis_angle 0.0
set prev_caxis_angle 0.0
}
...
#=============================================================
proc PB_CMD_move_arc { } {
#=============================================================
#MOM_output_literal ">>> MOVE ARC <<<"

global mom_cutcom_status
if ![info exists mom_cutcom_status] {set mom_cutcom_status "OFF"}
if {$mom_cutcom_status == "UNDEFINED"} {set mom_cutcom_status "OFF"}
if {$mom_cutcom_status != "OFF"} {
  #MOM_output_literal ">>>  CUTCOM= $mom_cutcom_status"

global mom_arc_direction
  #MOM_output_literal ">>>  ARC DIR= $mom_arc_direction"
...
if {($mom_arc_direction == "CLW" && $mom_cutcom_status == "LEFT") || ($mom_arc_direction == "CCLW" && $mom_cutcom_status == "RIGHT")} {
  set caxis_x [expr $mom_arc_center(0) - $mom_mcs_goto(0)]
  set caxis_y [expr $mom_arc_center(1) - $mom_mcs_goto(1)]
} else {
  set caxis_x [expr $mom_mcs_goto(0) - $mom_arc_center(0)]
  set caxis_y [expr $mom_mcs_goto(1) - $mom_arc_center(1)]
}
if [EQ_is_equal $caxis_x 0.0] {set caxis_x 0.0}
if [EQ_is_equal $caxis_y 0.0] {set caxis_y 0.0}

global caxis_angle
global prev_caxis_angle

set caxis_angle [expr atan2($caxis_y,$caxis_x)*$RAD2DEG]
if [EQ_is_gt $caxis_angle 360.0] {set caxis_angle [expr $caxis_angle - 360.0]}
if [EQ_is_lt $caxis_angle 0.0] {set caxis_angle [expr $caxis_angle + 360.0]}
#MOM_output_literal ">>>  CAXIS= $caxis_angle"

PB_CMD_set_caxis_dir
set prev_caxis_angle $caxis_angle
...
#=============================================================
proc PB_CMD_move_linear { } {
#=============================================================
#MOM_output_literal ">>> MOVE LINEAR"
...
set caxis_x [expr $mom_mcs_goto(0) - $mom_prev_mcs_goto(0)]
set caxis_y [expr $mom_mcs_goto(1) - $mom_prev_mcs_goto(1)]
...
if {$mom_cutcom_status == "LEFT"} {
  set caxis_angle [expr atan2($caxis_y,$caxis_x)*$RAD2DEG - 90.0]
} else {
  set caxis_angle [expr atan2($caxis_y,$caxis_x)*$RAD2DEG + 90.0]
}
...
#=============================================================
proc PB_CMD_move_rapid { } {
#=============================================================
#MOM_output_literal ">>> MOVE RAPID"
}


#=============================================================
proc PB_CMD_op_start { } {
#=============================================================
global mom_operation_name
MOM_output_literal "; $mom_operation_name"

MOM_force once S M_spindle X Y Z C_axis F
}
...
if ![info exists mom_group_name] {set mom_group_name "PROGRAM"}
...
#
#MOM_output_literal ">>> SET CAXIS DIR"
global caxis_dir
global caxis_angle
global prev_caxis_angle

      set del [expr $caxis_angle-$prev_caxis_angle]
