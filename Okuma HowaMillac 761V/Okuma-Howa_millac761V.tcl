...
#
#  Created by mannino  @  Tue Mar 18 16:32:44 2008 Eastern Daylight Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_post_description                  "This is a 3-Axis, Okuma-Howa Millac 761V Vertical Milling Machine."
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_rapid_feed_rate                   "1181"
...
#=============================================================
   ...
   MOM_force Once G_motion G_mode G Z M
   MOM_do_template end_of_program_1
   MOM_force Once G_motion G Y
   MOM_do_template end_of_program_1_1
...
#=============================================================
   MOM_force Once G_motion G_mode G Z M_spindle
...
#=============================================================
# Output total cutting and machine time
global mom_cutting_time mom_machine_time
set line1 [format "(TOTAL CUTTING TIME = %6.2f MINUTES)" $mom_cutting_time]
set line2 [format "(TOTAL MACHINE TIME = %6.2f MINUTES)" $mom_machine_time]
...
MOM_output_text "%"
MOM_output_text [format "O%04d" $prgnum ] 
MOM_output_text ([string toupper [lindex $fname end]])
MOM_output_literal "(OKUMA-HOWA MILLAC 761V 761V)"
MOM_output_text "${co}$prgid - $dt - [string toupper $mom_logname]${ci}"
MOM_output_text "G0 G17 G40 G80"
MOM_output_text "G0 G91 G30 Z0"
MOM_output_text "G0 G91 G30 X0 Y0"
MOM_output_text "M0"
}
...
#=============================================================
  MOM_force once G_adjust H S M_spindle S
}
