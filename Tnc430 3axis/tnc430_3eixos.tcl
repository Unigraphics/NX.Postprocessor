...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_motion X Y Z S M_spindle Text cutter_comp}
   set rapid_traverse_xy_blk {G_motion X Y S M_spindle Text cutter_comp}
   set rapid_traverse_yz_blk {G_motion Y Z S M_spindle Text cutter_comp}
   set rapid_traverse_xz_blk {G_motion X Z S M_spindle Text cutter_comp}
