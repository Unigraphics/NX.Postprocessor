...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_spindle_blk {X Y}
   set rapid_spindle_x_blk {X}
   set rapid_spindle_y_blk {Y}
   set rapid_spindle_z_blk {}
   set rapid_traverse_blk {G_motion X Y}
   set rapid_traverse_xy_blk {G_motion X Y}
   set rapid_traverse_yz_blk {G_motion Y}
   set rapid_traverse_xz_blk {G_motion X}
...
#=============================================================
global mom_date  mom_logname  start_flag

if {$start_flag == "1"} {
set start_flag  0
MOM_set_seq_off
MOM_output_literal "; Usuario: $mom_logname"
MOM_output_literal "; Data   : $mom_date"
MOM_output_literal "; =============================================="
MOM_set_seq_on
MOM_output_literal "G90"
MOM_output_literal "G40"
MOM_output_literal "G99"
MOM_output_literal "G71"
MOM_output_literal "O5"
MOM_output_literal "G92 X0.0 Y0.0"
...
#=============================================================
proc PB_CMD_redefine_mom_rapid { } {
#=============================================================
#=============================================================
proc MOM_rapid_move { } {
#=============================================================
