...
###############################################################
# Description												#			
# Postprocessor for machine: DMU-35M with HAIDENHAIN TNC-310	 	#
# Serial number: 											#
...
# Проверка если имя програмы содержит буквы, обработка 
# прерывается и выдается сообщение об ошибке  
	set file_name [string toupper $mom_output_file_basename]       
  	set is_name_ok [regexp {[A-Z]} $file_name]
  	
  	if {$is_name_ok == "1"} {
  		MOM_abort "Имя программы должно состоять только из цифр"
  	}	
}
#=============================================================
...
#=============================================================
  	MOM_force once M_spindle S X Y Z R F fourth_axis
}
#=============================================================
proc MOM_nurbs_move { } {
...
#=============================================================
	...
	MOM_abort "Этот станок не поддерживает сплайн интерполяцию. Используйте станок DMU-50eV или DMU-63V"
...
#=============================================================
	...
	global mom_motion_distance mom_tool_diameter cutcom_on
...
#=============================================================
  	...
  	global mom_cycle_feed_to mom_pos
...
#=============================================================
	...
	global mom_seqnum header_check_status status_block_create
