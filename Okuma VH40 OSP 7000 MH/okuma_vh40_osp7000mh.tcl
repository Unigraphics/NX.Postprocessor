########################## TCL Event Handlers ##########################
#
#  Created by kawakita  @  Fri Mar 04 09:55:51 2005 E. South America Daylight Time
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_motion G X Y Z H M_coolant}
   set rapid_spindle_x_blk {G_motion G X H M_coolant}
   set rapid_spindle_y_blk {G_motion G Y H M_coolant}
   set rapid_spindle_z_blk {G_motion G Z H M_coolant}
   set rapid_traverse_blk {G_motion X Y Z fourth_axis fifth_axis S M_spindle}
   set rapid_traverse_xy_blk {G_motion X Y fourth_axis fifth_axis S M_spindle}
   set rapid_traverse_yz_blk {G_motion Y Z fourth_axis fifth_axis S M_spindle}
   set rapid_traverse_xz_blk {G_motion X Z fourth_axis fifth_axis S M_spindle}
   set rapid_traverse_mod {fourth_axis fifth_axis}
...
global mom_machine_time
   ...
   if {$mom_machine_time >= "1"} {
       ...
       MOM_output_literal "(TEMPO DE USINAGEM= $min\MIN $seg\SEG)"
   } elseif {$mom_machine_time < "1"} {
       set seg [expr int($mom_machine_time*60)]
       MOM_output_literal "(TEMPO DE USINAGEM= 0\MIN $seg\SEG)"
   }

MOM_output_literal "\x04"
}
...
proc PB_CMD_info { } {
#=============================================================
# This is a 5-Axis (table/table) Milling Machine.
# Machine: Okuma VH 40
# Control: OSP 7000 M-H
}
...
return
  ...
  set mom_out_angle_pos($A) [ROTSET $mom_pos(4) $mom_prev_out_angle_pos(1)  $mom_kin_5th_axis_direction   $mom_kin_5th_axis_leader   $mom_sys_leader(fifth_axis)  $mom_kin_5th_axis_min_limit  $mom_kin_5th_axis_max_limit]
...
global vh40_offset_flag

set mom_machine_name OKUMA_VH40
...
set vh40_offset_flag 0

regsub -all ":" $mom_part_name "" mom_part_name

MOM_output_literal "([string toupper $mom_part_name])"
MOM_output_literal "([string toupper $mom_logname])"
MOM_output_literal "([string toupper $mom_machine_name])"
MOM_output_literal "([string toupper $user_date])"

# exec [MOM_ask_env_var "UGII_CAM_AUXILIARY_DIR"]ugwish.exe [MOM_ask_env_var UGII_CAM_POST_DIR]wrong_version.tcl
}
...
MOM_output_literal "IF\[VATOL EQ $mom_tool_number\]NT$mom_tool_number"
}
...
#=============================================================
proc PB_CMD_vh40_offset { } {
#=============================================================
global vh40_offset_flag
global mom_ude_vzofx1 mom_ude_vzofy1 mom_ude_vzofz1 mom_ude_vzofb1 mom_ude_vzofc1
global mom_ude_vzofx2 mom_ude_vzofy2 mom_ude_vzofz2 mom_ude_vzofb2 mom_ude_vzofc2
global mom_ude_vzofx3 mom_ude_vzofy3 mom_ude_vzofz3 mom_ude_vzofb3 mom_ude_vzofc3
global mom_ude_vzofx4 mom_ude_vzofy4 mom_ude_vzofz4 mom_ude_vzofb4 mom_ude_vzofc4
global mom_ude_vzofx5 mom_ude_vzofy5 mom_ude_vzofz5 mom_ude_vzofb5 mom_ude_vzofc5
global mom_ude_vzofx6 mom_ude_vzofy6 mom_ude_vzofz6 mom_ude_vzofb6 mom_ude_vzofc6
global mom_ude_vzofx7 mom_ude_vzofy7 mom_ude_vzofz7 mom_ude_vzofb7 mom_ude_vzofc7
global mom_ude_vzofx8 mom_ude_vzofy8 mom_ude_vzofz8 mom_ude_vzofb8 mom_ude_vzofc8


if { ![info exists mom_ude_vzofx1] } {
   MOM_abort  "\n\n ######################################## \
                 \n #####						##### \
                 \n #####	VH40 Offset nao foi definida!		##### \
                 \n #####						##### \
                 \n ######################################## \n\n"
}


if {$vh40_offset_flag == 0} {
   #
   MOM_output_literal "VZOFX\[1\]=[format %.3f $mom_ude_vzofx1]"
   MOM_output_literal "VZOFY\[1\]=[format %.3f $mom_ude_vzofy1]"
   MOM_output_literal "VZOFZ\[1\]=[format %.3f $mom_ude_vzofz1]"
   MOM_output_literal "VZOFB\[1\]=[format %.3f $mom_ude_vzofb1]"
   MOM_output_literal "VZOFC\[1\]=[format %.3f $mom_ude_vzofc1]"
   #
   MOM_output_literal "VZOFX\[2\]=[format %.3f $mom_ude_vzofx2]"
   MOM_output_literal "VZOFY\[2\]=[format %.3f $mom_ude_vzofy2]"
   MOM_output_literal "VZOFZ\[2\]=[format %.3f $mom_ude_vzofz2]"
   MOM_output_literal "VZOFB\[2\]=[format %.3f $mom_ude_vzofb2]"
   MOM_output_literal "VZOFC\[2\]=[format %.3f $mom_ude_vzofc2]"
   #
   MOM_output_literal "VZOFX\[3\]=[format %.3f $mom_ude_vzofx3]"
   MOM_output_literal "VZOFY\[3\]=[format %.3f $mom_ude_vzofy3]"
   MOM_output_literal "VZOFZ\[3\]=[format %.3f $mom_ude_vzofz3]"
   MOM_output_literal "VZOFB\[3\]=[format %.3f $mom_ude_vzofb3]"
   MOM_output_literal "VZOFC\[3\]=[format %.3f $mom_ude_vzofc3]"
   #
   MOM_output_literal "VZOFX\[4\]=[format %.3f $mom_ude_vzofx4]"
   MOM_output_literal "VZOFY\[4\]=[format %.3f $mom_ude_vzofy4]"
   MOM_output_literal "VZOFZ\[4\]=[format %.3f $mom_ude_vzofz4]"
   MOM_output_literal "VZOFB\[4\]=[format %.3f $mom_ude_vzofb4]"
   MOM_output_literal "VZOFC\[4\]=[format %.3f $mom_ude_vzofc4]"
   #
   MOM_output_literal "VZOFX\[5\]=[format %.3f $mom_ude_vzofx5]"
   MOM_output_literal "VZOFY\[5\]=[format %.3f $mom_ude_vzofy5]"
   MOM_output_literal "VZOFZ\[5\]=[format %.3f $mom_ude_vzofz5]"
   MOM_output_literal "VZOFB\[5\]=[format %.3f $mom_ude_vzofb5]"
   MOM_output_literal "VZOFC\[5\]=[format %.3f $mom_ude_vzofc5]"
   #
   MOM_output_literal "VZOFX\[6\]=[format %.3f $mom_ude_vzofx6]"
   MOM_output_literal "VZOFY\[6\]=[format %.3f $mom_ude_vzofy6]"
   MOM_output_literal "VZOFZ\[6\]=[format %.3f $mom_ude_vzofz6]"
   MOM_output_literal "VZOFB\[6\]=[format %.3f $mom_ude_vzofb6]"
   MOM_output_literal "VZOFC\[6\]=[format %.3f $mom_ude_vzofc6]"
   #
   MOM_output_literal "VZOFX\[7\]=[format %.3f $mom_ude_vzofx7]"
   MOM_output_literal "VZOFY\[7\]=[format %.3f $mom_ude_vzofy7]"
   MOM_output_literal "VZOFZ\[7\]=[format %.3f $mom_ude_vzofz7]"
   MOM_output_literal "VZOFB\[7\]=[format %.3f $mom_ude_vzofb7]"
   MOM_output_literal "VZOFC\[7\]=[format %.3f $mom_ude_vzofc7]"
   #
   MOM_output_literal "VZOFX\[8\]=[format %.3f $mom_ude_vzofx8]"
   MOM_output_literal "VZOFY\[8\]=[format %.3f $mom_ude_vzofy8]"
   MOM_output_literal "VZOFZ\[8\]=[format %.3f $mom_ude_vzofz8]"
   MOM_output_literal "VZOFB\[8\]=[format %.3f $mom_ude_vzofb8]"
   MOM_output_literal "VZOFC\[8\]=[format %.3f $mom_ude_vzofc8]"
   #
}


set vh40_offset_flag 1
}
