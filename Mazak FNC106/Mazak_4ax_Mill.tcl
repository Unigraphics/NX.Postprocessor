########################## TCL Event Handlers ##########################
#
#  Created by mannino  @  Mon Feb 05 09:20:05 2007 Eastern Daylight Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_post_description                  "4 Axis Vertical Mill, uses B for 4th axis rotation."
...
#=============================================================
   ...
   MOM_force Once G_mode fourth_axis M
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   MOM_do_template first_move_1_1
...
#=============================================================
   ...
   MOM_set_seq_off
   PB_CMD_program_id
   MOM_force Once G_cutcom G_feed G_motion G_mode G
...
MOM_output_literal "(MACHINE: FNC106)"
...
#=============================================================
proc PB_CMD_unclamp_fourth_axis_1 { } {
#=============================================================
#
#  This procedure is used by auto clamping to output the code
#  needed to unclamp the fourth axis.  
