...
#
#  Created by zhang  @  Thu Apr 02 15:33:54 2009 China Standard Time
...
#=============================================================
   MOM_do_template end_operation
   MOM_do_template pro_spindle_off
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   MOM_do_template tool_change_init
   PB_CMD_spindle_sfm_prestart
   MOM_do_template tool_change_move
...
#=============================================================
proc PB_CMD_end_operation { } {
#=============================================================
global mom_next_oper_has_tool_change mom_next_tool_status
#if has tool change , cancel tool adjust and coolant off
...
set pop_tool_change_code "[format "%2d" $mom_tool_number][format "%2d" $mom_tool_adjust_register]"
MOM_output_to_listing_device "$pop_tool_change_code"
}
