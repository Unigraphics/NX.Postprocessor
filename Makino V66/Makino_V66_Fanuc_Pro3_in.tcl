...
#
#  Created by zhang  @  Tue Jul 29 15:55:43 2008 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_post_description                  "This is a post for Makino 3 axis V22, V33, V66, V77, V99, S33, S66, GF6, GF8, GF12."
...
#=============================================================
proc PB_CMD_output_G05_P0 { } {
#=============================================================
global pop_gi_mode
if {$pop_gi_mode == "M250"} {
    MOM_do_template G05_P0
} elseif { $pop_gi_mode == "M251" } {
    MOM_do_template G05_P0
} else {
}
}
...
#=============================================================
proc PB_CMD_output_gi_mode { } {
#=============================================================
global pop_gi_mode
if {$pop_gi_mode == "M250"} {
    MOM_do_template M250
    MOM_do_template G05_P10000
} elseif { $pop_gi_mode == "M251" } {
    MOM_do_template M251
    MOM_do_template G05_P10000
} else {
}
}
...
#=============================================================
proc PB_CMD_reset_vars { } {
#=============================================================
global pop_gi_mode

set pop_gi_mode "AUTO"
}
...
#=============================================================
     global mom_gi_mode
     global pop_gi_mode
     if {$mom_gi_mode == "M250_HIGH_ACCURACY_MODE"} {
        set pop_gi_mode "M250"
     } elseif { $mom_gi_mode == "M251_HIGH_SPEED_MODE" } {
        set pop_gi_mode "M251"
     } 
}
};#uplevel
}
