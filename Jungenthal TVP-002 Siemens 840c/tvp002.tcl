########################## TCL Event Handlers ##########################
#
#  Created by edson.kawakita  @  Tue Dec 14 10:56:35 2004 E. South America Daylight Time
...
#=============================================================
proc PB_CMD_before_end_of_program { } {
#=============================================================
...
################################################################################
#
# This is a 2-Axis, 2-Turrets Vertical Lathe Machine.
#
# Jungenthal TVP-002 / Siemens 840C.
#
#
# Note:
#	UDE Select Head must be set to define the turret (Left or Right)
...
set mom_machine_name tvp002

   MOM_output_literal "$mom_sys_rewind_stop_code[string toupper mpf1]"
...
#=============================================================
  ...
  if {$mom_spindle_speed <= 40} {
     set udc_spindle_range_code 41
  } elseif {$mom_spindle_speed > 40} {
