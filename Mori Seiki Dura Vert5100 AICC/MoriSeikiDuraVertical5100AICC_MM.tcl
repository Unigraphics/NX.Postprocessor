...
#
#  Created by wrightj  @  Tuesday, December 09, 2008 11:12:16 AM Central Standard Time
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_adjust G_mode G_motion X Y Z H S M_coolant}
   set rapid_spindle_x_blk {G_adjust G_mode G_motion X H S M_coolant}
   set rapid_spindle_y_blk {G_adjust G_mode G_motion Y H S M_coolant}
   set rapid_spindle_z_blk {G_adjust G_mode G_motion Z H S M_coolant}
...
if {[info exists is_HPCC_mode]} {
  if { $is_HPCC_mode == "ON" } {
    MOM_output_literal "$co AI CONTOUR CONTROL MODE OFF $ci"
    MOM_force ONCE Q_AICC G_AICC
...
set co $mom_sys_control_out 
   ...
   if { $mom_command_status == "ACTIVE"} {       
             MOM_output_literal "$co AI CONTOUR CONTROL MODE ON $ci"
             MOM_force ONCE Q_AICC G_AICC           
