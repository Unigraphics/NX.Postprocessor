...
#
#  Created by xiongx  @  Thu Mar 26 10:34:10 2009 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_delay_code(SECONDS)               "04" 
  set mom_sys_delay_code(REVOLUTIONS)           "04" 
...
#=============================================================
  global mom_tool_change_type mom_manual_tool_change
   ...
   MOM_force Once M
   MOM_do_template tool_change_M06
}
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_adjust G_motion G_mode X Y H Z M_coolant}
...
#=============================================================
MOM_output_literal "G28G91Y0Z0"
MOM_output_literal "G90G80G40G00M30"
}
...
#=============================================================
MOM_output_literal "G90G80G40G00"
}


#=============================================================
proc PB_CMD_force_G_motion { } {
#=============================================================
...
if {[info exists mom_group_name]} {
  MOM_output_literal "G[expr $mom_fixture_offset_value + 53]($mom_group_name)"
 } else {
  MOM_output_literal "G[expr $mom_fixture_offset_value + 53]($mom_operation_name)"
}

MOM_output_literal "G28G91X0Y0Z0"
}
...
#=============================================================
MOM_output_literal "G28G91Y0Z0"
MOM_output_literal "G90G80G40G00M01"
}
