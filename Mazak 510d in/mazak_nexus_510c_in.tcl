...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_post_description                  "Mazak nexus 510c\n\
                                                 4 axis with B table."
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_rapid_feed_rate                   "1417"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_mode G_adjust G_motion X Y Z fourth_axis H}
   set rapid_spindle_x_blk {G_mode G_adjust G_motion X fourth_axis H}
   set rapid_spindle_y_blk {G_mode G_adjust G_motion Y fourth_axis H}
   set rapid_spindle_z_blk {G_mode G_adjust G_motion Z fourth_axis H}
   set rapid_traverse_blk {G_mode G_motion X Y Z fourth_axis S M_spindle}
   set rapid_traverse_xy_blk {G_mode G_motion X Y fourth_axis S M_spindle}
   set rapid_traverse_yz_blk {G_mode G_motion Y Z fourth_axis S M_spindle}
   set rapid_traverse_xz_blk {G_mode G_motion X Z fourth_axis S M_spindle}
...
#=============================================================
   ...
   MOM_set_seq_off
   PB_CMD_program_number
   global mom_date
   MOM_output_literal "(UGNX POSTING DATE: $mom_date)"
   MOM_force Once G_mode G_cutcom G_adjust G_motion G_motion
...
#=============================================================
proc PB_CMD_next_tool_number { } {
#=============================================================
global mom_next_tool_number
MOM_output_text "$mom_next_tool_number"
...
#  properties, select attribute.  Use the string "program_1" as the 
...
if {![info exists mom_attr_PROGRAMVIEW_PROGRAM_1]} {set mom_attr_PROGRAMVIEW_PROGRAM_1 "O00000001"}
if {![info exists mom_attr_PROGRAMVIEW_PROGRAM_2]} {set mom_attr_PROGRAMVIEW_PROGRAM_2 "O00000002"}
...
global mom_tool_axis mom_pos_arc_plane
...
#=============================================================
  MOM_force once S M_spindle X Y Z fourth_axis F
}
