...
#
#  Created by wrightj  @  Wed May 28 10:51:52 2008 Central Daylight Time
...
#=============================================================
global mom_firstinitial_move

if { $mom_firstinitial_move == 0 } { return
} else {
MOM_output_literal "M48"
MOM_output_literal "M80"
set mom_firstinitial_move 0
}
}
...
if {![info exists mom_coolant_status] } {MOM_output_literal "M06"
return}
if {$mom_coolant_status == "UNDEFINED"} {MOM_output_literal "M06"
set output_m06 1}
}
...
#=============================================================
global output_m06
global output_rpmpreset

set output_rpmpreset 0
set output_m06 0
}
...
if {$mom_tool_number > 0 && $mom_tool_number < 7} {
MOM_output_literal "M27"
MOM_output_literal "M2$mom_tool_number"} elseif {$mom_tool_number > 6 && $mom_tool_number < 11} {
MOM_output_literal "M37"
MOM_output_literal "M3[expr $mom_tool_number-6]"
}
}
...
#=============================================================
  ...
  if {$output_rpmpreset == 1} {return}

  if {$mom_spindle_mode == "SFM" || $mom_spindle_mode == "SMM"} {
    MOM_force once G_spin M_spindle S M_range
    MOM_do_template spindle_rpm_preset
    set output_rpmpreset 1
  }
}
