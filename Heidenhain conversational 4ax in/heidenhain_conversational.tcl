########################## TCL Event Handlers ##########################
#
#  Created by maynardj  @  Thu Jun 02 14:21:25 2005 Pacific Daylight Time
...
#=============================================================
   CIRCLE_SET
   PB_CMD_test_for_arc_plane
   MOM_force Once Text
   MOM_do_template circular_move
   PB_CMD_force_once_X_pos_Y_pos_Z_pos
...
#=============================================================
 ...
 if { $mom_motion_event == "bore_move" } {
         MOM_do_template  cycle_block_boring	;# ream or bore
  } else {
          MOM_do_template cycle_block_drilling		;# cycle def 200
  }
...
#=============================================================
proc PB_CMD_force_once_X_pos_Y_pos_Z_pos { } {
#=============================================================
global mom_arc_axis
...
#=============================================================
proc PB_CMD_test_for_arc_plane { } {
#=============================================================
global mom_pos_arc_plane

if { $mom_pos_arc_plane == "XY" } {
    MOM_suppress Once Z_arc_center
    MOM_force Once X_arc_center Y_arc_center

 } elseif { $mom_pos_arc_plane == "ZX" } {
    MOM_suppress Once Y_arc_center
    MOM_force Once X_arc_center Z_arc_center

} elseif { $mom_pos_arc_plane == "YZ" } {
    MOM_suppress Once X_arc_center
    MOM_force Once Y_arc_center Z_arc_center
}
}
