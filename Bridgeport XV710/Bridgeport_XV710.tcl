...
#
#  Created by mannino  @  Thu Mar 27 17:41:44 2008 Eastern Daylight Time
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_feed G_motion G_mode X Y Z S M_spindle}
   set rapid_traverse_xy_blk {G_feed G_motion G_mode X Y S M_spindle}
   set rapid_traverse_yz_blk {G_feed G_motion G_mode Y Z S M_spindle}
   set rapid_traverse_xz_blk {G_feed G_motion G_mode X Z S M_spindle}
...
MOM_output_text [format "([string toupper [lindex $fname end]])" $prgnum ] 
MOM_output_literal "(MACHINE BRIDGEPORT XV710)"
