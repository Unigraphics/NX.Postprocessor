########################## TCL Event Handlers ##########################
#
#  Created by lili  @  Tue Aug 29 17:26:21 2006 China Standard Time
...
#=============================================================
  global mom_tool_change_type mom_manual_tool_change
   PB_CMD_get_first_spindle_tool_mode_1
   MOM_force Once T
   MOM_do_template tool_change_1
   MOM_do_template auto_tool_change_1
   PB_CMD_tool_preselect
   PB_CMD_next_tool_preparation
   PB_CMD_swivel_head
}
...
#=============================================================
proc PB_CMD_get_first_spindle_tool_mode_1 { } {
#=============================================================
# This proc is used to get tool axis. If it's vertical spingle tool, set 
# spindle_tool_code 75. If it's horizontal spingdle tool, set spindle_tool_code
# 73.

global spindle_tool_direction
global spindle_tool_code
global mom_sys_tool_change_code
global mom_pocket_id
global pre_spindle_tool_code

set pre_spindle_tool_code "73"
set spindle_tool_code "73"

if {$mom_pocket_id == 1} {
    set spindle_tool_code "75"
    set mom_sys_tool_change_code "6"
    set spindle_tool_direction "V"
} else {
    MOM_output_literal "M73"
    set mom_sys_tool_change_code "77"
    set spindle_tool_direction "H"

       switch "$mom_pocket_id" {
        "2" {
           set spindle_tool_code "73"
        } 
        "3" {
           set spindle_tool_code "74"
        }
        "4" {
           set spindle_tool_code "75"
        }
        "5" {
           set spindle_tool_code "76"
        }
       }
...
#=============================================================
proc PB_CMD_get_spindle_tool_mode { } {
#=============================================================
# This proc is used to get tool axis. If it's vertical spingle tool, set 
# spindle_tool_code 75. If it's horizontal spingdle tool, set spindle_tool_code
# 73.
...
if {$mom_pocket_id == 1} {
    if {$spindle_tool_direction == "H" && ![EQ_is_zero $tool_is_same]} {
        MOM_output_literal "M73"
        set mom_sys_tool_change_code "77"
    } else {
        set mom_sys_tool_change_code "6"
    ...
    set pre_spindle_tool_code $spindle_tool_code
    ...
    if {$spindle_tool_direction == "V" && ![EQ_is_zero $tool_is_same]} {
        set mom_sys_tool_change_code "6"
    } else {
        if {$spindle_tool_direction == "H" && ![EQ_is_zero $tool_is_same]} {
            set swivel_head "YES"
        } else {
            if {$spindle_tool_direction == "H" && $pre_spindle_tool_code == 74} {
...
if {[info exists mom_next_tool_number]} {
    ...
    MOM_output_text "NEXT TOOL ($mom_next_tool_number)"
} else {
...
#=============================================================
proc PB_CMD_next_tool_preparation { } {
#=============================================================
 global mom_pocket_id
 global mom_next_pocket_id
 global mom_tool_number
 global mom_next_tool_number
 
if {$mom_pocket_id != $mom_next_pocket_id} {
  if {$mom_pocket_id == 1 || $mom_next_pocket_id == 1} {
    if {$mom_tool_number != $mom_next_tool_number} {
...
#=============================================================
proc PB_CMD_set_tool { } {
#=============================================================
global mom_next_tool_number

if {![info exists mom_next_tool_number]} {
MOM_output_literal "M63"
} elseif {$mom_next_tool_number==""} {
MOM_output_literal "M63"
}
}
...
#=============================================================
proc PB_CMD_set_tool_offset_plane { } {
#=============================================================
global mom_tool_axis
global mom_sys_adjust_code

if [EQ_is_equal [expr abs($mom_tool_axis(0))] 1.0] {
    set mom_sys_adjust_code "54"
}
if [EQ_is_equal [expr abs($mom_tool_axis(1))] 1.0] {
    set mom_sys_adjust_code "55"
}
...
#=============================================================
 ...
 global swivel_head
 MOM_output_text " " 
 MOM_output_text "($mom_path_name) "
 set swivel_head "NO"
}


#=============================================================
proc PB_CMD_swivel_head { } {
#=============================================================
global spindle_tool_code
global pre_spindle_tool_code
global mom_pocket_id
...
if {$mom_pocket_id != 1} {
  if {[expr $pre_spindle_tool_code-$spindle_tool_code] == 1 ||  [expr $pre_spindle_tool_code-$spindle_tool_code] == -3} {
     MOM_output_literal "M17"
  }
    MOM_do_template spindle_tool_mode
}
}
