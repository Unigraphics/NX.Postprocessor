...
#
#  Created by suyo  @  Thu Aug 30 14:14:11 2007 China Standard Time
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_mode G_motion G_feed X Y Z fourth_axis}
   set rapid_traverse_xy_blk {G_mode G_motion G_feed X Y fourth_axis}
   set rapid_traverse_yz_blk {G_mode G_motion G_feed Y Z fourth_axis}
   set rapid_traverse_xz_blk {G_mode G_motion G_feed X Z fourth_axis}
