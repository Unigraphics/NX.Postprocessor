...
#
#  Created by marks  @  Tue Sep 16 14:01:55 2008 Eastern Daylight Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_output_file_suffix                "dat"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_y_axis_limit                      "24" 
  set mom_kin_z_axis_limit                      "24" 
...
#=============================================================
   MOM_force Once S
   MOM_do_template spindle_slowdown
   MOM_force Once M_spindle
   MOM_do_template spindle_turn_off
   MOM_force Once M_coolant
   MOM_do_template coolant_turn_off
   MOM_force Once G_mode G_return Z
   MOM_do_template return_motion_1
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   COOLANT_SET ; CUTCOM_SET ; SPINDLE_SET ; RAPID_SET
   MOM_force Once G_motion G_mode G X Y T
   ...
   MOM_force Once Text M_coolant
   MOM_do_template coolant_turn_on
   global mom_operation_name
   MOM_output_literal "($mom_operation_name)"
   PB_CMD_initial_move_force
...
#=============================================================
proc PB_CMD_arc_angle_check { } {
#=============================================================
# Check for arc angle greater then 180 deg
...
if {$mom_arc_angle <= 180.0} {
  ...
  set arc_radius [expr (-1 * $mom_arc_radius)]
}
}
...
#=============================================================
proc PB_CMD_initial_move_force { } {
#=============================================================
MOM_force once F
}
...
#=============================================================
proc PB_CMD_set_tool_vars { } {
#=============================================================
global tool_length_reg
global tool_cutcom_reg
...
MOM_output_literal "mom_tool_cutcom_register=$mom_tool_cutcom_register"
}
...
if [info exists mom_parent_group_name] {
  MOM_output_literal "$mom_parent_group_name"
} else {
  MOM_output_literal "O9999"
}

set output_file_basename [string toupper $mom_output_file_basename]
MOM_output_literal "($output_file_basename)"

set logname [string toupper $mom_logname]
#MOM_output_literal "(BY: $logname)"

#set date [string toupper $mom_date]
...
#=============================================================
proc PB_CMD_startup_block { } {
#=============================================================
global startup_block

set startup_block [expr ($startup_block + 1000)]

MOM_output_literal "N$startup_block"
}
...
#=============================================================
# Suppress tool cutcom register if drilling tool
