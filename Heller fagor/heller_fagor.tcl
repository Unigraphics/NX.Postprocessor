##############################################################################
# Description
#     This is the event handler file for Heller VH1000 / Fagor 8050/55M - 4 
# axis mill.
#
#
# Revisions
#
#   Date        Who   Reason
# 12-nov-2002   emk   Original.
# 13-nov-2002   emk   To create the appropriate fixture G code, a fixture
#                     offset value must be specified on Mill Orient (MCS) group.
#                     Ex.: Fixture Offset = 54 --> G54.
#
# $HISTORY$
#     This post-processor was created using POSTBUILDER_VERSION 2.0.1.1
...
global mom_fixture_offset_value
   ...
   MOM_set_seq_off
   MOM_output_literal "(MSG \"ARQUIVO: [string toupper $mom_part_name\")]"
   MOM_output_literal "(MSG \"PROGRAMADOR: [string toupper $mom_logname\")]"
   MOM_output_literal "(MSG \"MAQUINA: [string toupper $mom_machine_name\")]"
   MOM_output_literal "(MSG \"DATA: [string toupper $mom_date\")]"
   MOM_set_seq_on
...
MOM_set_seq_off
MOM_output_literal "(MSG \"OPERACAO: $mom_path_name - FERRAMENTA: $mom_tool_name\")"
MOM_set_seq_on
