########################## TCL Event Handlers ##########################
#
#  Created by lili  @  Thu Nov 16 17:41:32 2006 China Standard Time
...
#=============================================================
  global cycle_init_flag
   ...
   PB_CMD_cycle_bore
   MOM_do_template cycle_bore_back_3
   set cycle_init_flag FALSE
}
...
#=============================================================
  global cycle_init_flag
   ...
   PB_CMD_cycle_bore_drag
   MOM_do_template cycle_bore_drag_3
   set cycle_init_flag FALSE
}
...
#=============================================================
  global cycle_init_flag
   ...
   PB_CMD_cycle_bore_dwell
   MOM_do_template cycle_bore_dwell_3
   set cycle_init_flag FALSE
}
...
#=============================================================
  global cycle_init_flag
   ...
   PB_CMD_cycle_bore_manual
   MOM_do_template cycle_bore_manual_3
   set cycle_init_flag FALSE
}
...
#=============================================================
  global cycle_init_flag
   ...
   PB_CMD_cycle_bore_manual_dwell
   MOM_do_template cycle_bore_manual_dwell_3
   set cycle_init_flag FALSE
}
...
#=============================================================
  global cycle_init_flag
   ...
   PB_CMD_cycle_drill_break_chip_init
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   COOLANT_SET ; CUTCOM_SET ; SPINDLE_SET ; RAPID_SET
   PB_CMD_initial_move_force_address
...
#=============================================================
 ...
 # to ensure the hole Z height Q203 is set correctly.
  ...
  if {$cycle_init_flag == "TRUE"} {
    MOM_do_template sm_cycle_bore_drag
  }
...
#=============================================================
 ...
 # to ensure the hole Z height Q203 is set correctly.
  ...
  if {$cycle_init_flag == "TRUE"} {
    MOM_do_template sm_cycle_bore_dwell
  }
...
#=============================================================
 ...
 # to ensure the hole Z height Q203 is set correctly.
  ...
  if {$cycle_init_flag == "TRUE"} {
    MOM_do_template sm_cycle_bore_manual
  }
...
#=============================================================
proc PB_CMD_cycle_bore_manual_dwell { } {
#=============================================================
  global cycle_init_flag 
  global mom_pos		;# xy and especially Z of this hole
  global mom_prev_pos	;# ditto - previous hole
 ...
 # to ensure the hole Z height Q203 is set correctly.
  ...
  if {$cycle_init_flag == "TRUE"} {
    MOM_do_template sm_cycle_bore_manual_dwell
  }
...
#=============================================================
proc PB_CMD_cycle_drill_break_chip_init { } {
#=============================================================
  global cycle_init_flag 
  global mom_pos		;# xy and especially Z of this hole
  global mom_prev_pos	;# ditto - previous hole
 ...
 # to ensure the hole Z height Q203 is set correctly.
  ...
  if {$cycle_init_flag == "TRUE"} {
    MOM_do_template sm_cycle_drill_break_chip
  }
...
#=============================================================
proc PB_CMD_cycle_drill_deep_init { } {
#=============================================================
  global cycle_init_flag 
  global mom_pos		;# xy and especially Z of this hole
  global mom_prev_pos	;# ditto - previous hole
 ...
 # to ensure the hole Z height Q203 is set correctly.
  ...
  if {$cycle_init_flag == "TRUE"} {
    MOM_do_template sm_cycle_drill_deep
  }
...
#=============================================================
proc PB_CMD_cycle_drill_dwell_init { } {
#=============================================================
  global cycle_init_flag 
  global mom_pos		;# xy and especially Z of this hole
  global mom_prev_pos	;# ditto - previous hole
 ...
 # to ensure the hole Z height Q203 is set correctly.
  ...
  if {$cycle_init_flag == "TRUE"} {
    MOM_do_template sm_cycle_drill_dwell
  }
...
#=============================================================
 ...
 # to ensure the hole Z height Q203 is set correctly.
  ...
  if {$cycle_init_flag == "TRUE"} {
    MOM_do_template sm_cycle_drill
  }
 ...
 # to ensure the hole Z height Q203 is set correctly.
  ...
  if {$cycle_init_flag == "TRUE"} {
    ...
    if { [info exists mom_cycle_option] && $mom_cycle_option == "OPTION" } {
        MOM_do_template sm_cycle_tap_float
    } else {
        MOM_do_template sm_cycle_tap_rigid
    }
  }
...
#=============================================================
proc PB_CMD_initial_move_force_address { } {
#=============================================================
MOM_force once S M_spindle
}
