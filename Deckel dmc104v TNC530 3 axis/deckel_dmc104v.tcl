########################## TCL Event Handlers ##########################
#
#  Created by kleber.ronconi  @  Thu Dec 18 12:29:50 2003 E. South America Daylight Time
...
global mom_pos  mom_contact_center

#if {$mom_cutter_data_output_indicator == 2} {
#    set mom_pos(0) $mom_contact_center(0)
#    set mom_pos(1) $mom_contact_center(1)
#    set mom_pos(2) $mom_contact_center(2)
#}
}
...
set tempo_anterior   0
 ...
 MOM_output_literal "; DECKEL MAHO DMC104V - iTNC530"
 MOM_output_literal "; ----------------------------------------------- "
...
MOM_output_literal ";---- OPERACAO: $mom_path_name  -  $mom_tool_name ----"
}
...
#***************************
 set user_tcl_file ${cam_post_dir}deckel_itnc530_user.tcl
