...
#  KOMO_Router.tcl -
#
#  Created by wrightj  @  Tue Dec 23 08:41:00 2008 Central Daylight Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_output_file_suffix                "out"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_post_description                  "KOMO con control FANUC de Van Beuren"
...
#=============================================================
   MOM_force Once G_return G_mode Z M_spindle
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_motion G_mode G Text X Y Z M_spindle S}
   set rapid_traverse_xy_blk {G_motion G_mode G Text X Y M_spindle S}
   set rapid_traverse_yz_blk {G_motion G_mode G Text Y Z M_spindle S}
   set rapid_traverse_xz_blk {G_motion G_mode G Text X Z M_spindle S}
...
#=============================================================
proc PB_CMD_cabezal_sync { } {
#=============================================================

uplevel #0 {

proc MOM_cabezal_sync {} {

global mom_cab_sync mom_cabezal_1 mom_cabezal_2 mom_cabezal_3 mom_cabezal_4
global mom_tool_number
  
if {[info exists mom_cab_sync] &&  $mom_cab_sync == "SI" } {
    MOM_do_template special_tool_change
  } else {
   switch $mom_tool_number {
      1  {MOM_output_literal  “T1000” }
      2  {MOM_output_literal  “T0200” }
      3  {MOM_output_literal  “T0030” }
      4  {MOM_output_literal  “T0004” }
         }
  }
...
#=============================================================
proc PB_CMD_group_name { } {
#=============================================================
global mom_group_name

if {[info exists mom_group_name]} {
	MOM_output_literal "O$mom_group_name"
}
}
...
#=============================================================
proc PB_CMD_sincronizar_cabezales { } {
#=============================================================
# Este comando es para sincronizar los cabezales de un router KOMO con 4 cabezales.
# Cambia la forma en que la T aparece para el cambio de herramienta. 
#
uplevel #0{
proc MOM_sincronizar {} {

global mom_sync_cabezal
global mom_cabezal_1
global mom_cabezal_2
global mom_cabezal_3
global mom_cabezal_4
global mom_numero_hta
  

if { mom_sync_cabezal==SI } 
  {
  set mom_numero_hta T$mom_cabezal_1$mom_cabezal_2$mom_cabezal_3$mom_cabezal_4
