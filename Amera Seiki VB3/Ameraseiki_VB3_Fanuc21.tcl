########################## TCL Event Handlers ##########################
#
#  MetalQuest_Ameraseiki_VB3_Fanuc21.tcl -
#
#  Created by xiongx  @  Mon Dec 03 17:48:42 2007 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_coolant_code(THRU)                "12" 
  set mom_sys_coolant_code(TAP)                 "8"  
  set mom_sys_coolant_code(OFF)                 "13" 
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_x_axis_limit                      "126"
  set mom_kin_y_axis_limit                      "76" 
...
#=============================================================
   ...
   MOM_force Once G_mode G_motion G_cutcom G_plane
...
#=============================================================
proc PB_CMD_coolant_air_checker { } {
#=============================================================
uplevel #0 {
...
#=============================================================
   ...
   if { [info exists mom_coolant_text_defined] } {
     MOM_output_literal "$mom_coolant_text_defined"
    if { $mom_coolant_text_defined == 1 } {
     MOM_output_literal "$mom_coolant_text"
   if { $mom_coolant_text == "M51"} { 
	#MOM_output_literal "$mom_sys_coolant_code(ON)"
        set mom_coolant_status "AIRON"  
        set mom_coolant_mode "AIRON"    
...
set mom_coolant_status "AIR"
} else {
MOM_output_literal "mom_coolant_status is not exist" 
}
}
...
if { $mom_coolant_status == "AIRON" } {
   set mom_coolant_status "AIROFF"
}
}
