########################## TCL Event Handlers ##########################
#
#  Created by Administrator  @  Tue Mar 16 09:15:36 2004 E. South America Daylight Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_thread_wire                       "60" 
  set mom_sys_cut_wire                          "50" 
...
proc PB_cutcom_move { } {
#=============================================================
   MOM_force Once G_motion G_cutcom X Y
...
global udv_first_linear_move

set udv_first_linear_move 1
...
#=============================================================
global mom_regime_register
}


#=============================================================
proc PB_CMD_enfia_fio { } {
#=============================================================
...
global mom_thread_wire_text 
         ...
         MOM_output_literal "$thread_wire_text"
}
}


#=============================================================
proc PB_CMD_inclinacao_fio { } {
#=============================================================
global mom_tool_axis_type
global mom_operation_type
MOM_output_literal "TOOL_AXIS_TYPE=$mom_tool_axis_type"

if {$mom_tool_axis_type == 0 || $mom_tool_axis_type == 2} {
   MOM_output_literal "M15 P00"
  } else {
  MOM_output_literal "M15 P11"
  }
...
proc PB_CMD_mcs { } {
#=============================================================
global mom_current_motion mom_wire_slope
global udv_first_linear_move

if {$udv_first_linear_move == 1} {

    if {$mom_wire_slope != 0} {
        MOM_output_literal "M15 P1"
    } else {
        MOM_output_literal "M15 P0"
    }

    MOM_output_literal "M24"
    MOM_output_literal "M28"
    MOM_force once X Y

    if {$mom_wire_slope != 0} {
        MOM_do_template mcs_move_ij
    } else {
        MOM_do_template mcs_move
    }

    MOM_force once X Y
    MOM_output_literal "/M60"
    set udv_first_linear_move 0
}
}
...
proc MOM_regime_load {} {    
global mom_regime_register
global mom_rough_passes
global mom_finish_passes
if {$mom_rough_passes == 1 && $mom_finish_passes == 0} {
   MOM_output_literal "D0"
  } else {
  MOM_output_literal "D0 S$mom_regime_register"
  }
  }
}
...
#=============================================================
proc PB_CMD_wire_angles { } {
#=============================================================
proc MOM_wire_angles {} {

global mom_wire_slope
global mom_wedm_cut_direction
global inclinacao
global mom_cutcom_status mom_wire_cutcom_mode

CUTCOM_SET

  if {$mom_wire_cutcom_mode == "LEFT"} {
     set inclinacao 51
  } elseif {$mom_wire_cutcom_mode == "RIGHT"} {
     set inclinacao 52
  } 
