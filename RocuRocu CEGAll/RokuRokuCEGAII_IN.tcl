...
#
#  Created by wrightj  @  Wednesday, December 03, 2008 12:26:36 PM Central Standard Time
#  with Post Builder version  6.0.2.
#
########################################################################
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_post_builder_version              "6.0.2"
...
#=============================================================
   ...
   MOM_force Once G x_zero y_zero
...
#=============================================================
   ...
   MOM_force Once G_motion P_Super_pc
   MOM_do_template super_pc_off
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   MOM_force Once G_mode G_motion G x_zero y_zero
...
#=============================================================
  global mom_tool_change_type mom_manual_tool_change
   PB_CMD_set_sequence_number_to_tool_number
   MOM_set_seq_on
   MOM_force Once T M
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   MOM_force Once G_adjust H Z
   MOM_do_template initial_move_2
   MOM_force Once M_super_pc
   MOM_do_template super_pc_on_2
   MOM_force Once G_motion P_Super_pc
   MOM_do_template super_pc_on_1
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_adjust G_mode G_motion X Y H Z M_coolant}
   ...
   set rapid_spindle_z_blk {G_adjust G_mode G_motion H Z M_coolant}
   set rapid_traverse_blk {G_mode G_motion X Y Z S D M_spindle}
   set rapid_traverse_xy_blk {G_mode G_motion X Y S D M_spindle}
   set rapid_traverse_yz_blk {G_mode G_motion Y Z S D M_spindle}
   set rapid_traverse_xz_blk {G_mode G_motion X Z S D M_spindle}
...
#=============================================================
   ...
   MOM_force Once G_motion G_cutcom
...
if {![info exists mom_work_coordinate_number]} {
set mom_work_coordinate_number 1
}
}
...
#=============================================================
global mom_sys_cutcom_plane_code
global mom_cutcom_plane

#if { ![info exists mom_sys_cutcom_plene_code] } {
#MOM_output_literal "mom_sys_cutcom_plene_code does not existe"
#} else {
#MOM_output_literal "$mom_sys_cutcom_plane_code"
#}
#if { ![info exists mom_cutcom_plane] } {
#MOM_output_literal "mom_cutcom_plane does not exist"
#} else {
#MOM_output_literal "$mom_cutcom_plane"
#}

if { $mom_cutcom_plane == "XYPLAN"} {
MOM_force once X Y I J
} elseif { $mom_cutcom_plane == "YZPLAN"} {
MOM_force once Y Z J K
} elseif { $mom_cutcom_plane == "ZXPLAN"} {
...
#=============================================================
proc PB_CMD_set_sequence_number_to_tool_number { } {
#=============================================================
global mom_tool_number mom_seqnum

set mom_seqnum $mom_tool_number
}


#=============================================================
proc PB_CMD_set_sequence_number_to_tool_number_1 { } {
#=============================================================
global mom_tool_number mom_seqnum
