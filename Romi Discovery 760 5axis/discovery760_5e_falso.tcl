########################## TCL Event Handlers ##########################
#
#  Created by kleber.ronconi  @  Mon Apr 05 12:40:06 2004 E. South America Daylight Time
...
#=============================================================
   ...
   MOM_force Once G D fifth_axis S
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_motion G_mode X Y Z fifth_axis S M_spindle fourth_axis}
   set rapid_traverse_xy_blk {G_motion G_mode X Y fifth_axis S M_spindle fourth_axis}
   set rapid_traverse_yz_blk {G_motion G_mode Y Z fifth_axis S M_spindle fourth_axis}
   set rapid_traverse_xz_blk {G_motion G_mode X Z fifth_axis S M_spindle fourth_axis}
...
#=============================================================
global mom_machine_time	tempo_acumulado

set tempo		[expr $mom_machine_time - $tempo_acumulado ]
set tempo_acumulado	[expr $mom_machine_time]

#MOM_output_literal ";(TEMPO DA OPERACAO: [format "%.2f" $tempo] min.)"
}
...
#=============================================================
 ...
 global mom_tool_name  mom_tool_number  mom_tool_diameter
 global mom_tool_length  mom_tool_flute_length
 global mom_tool_corner1_radius	mom_tool_catalog_number

 MOM_output_literal ";===================================================="
 MOM_output_literal ";OPERERACAO : $mom_path_name"
 MOM_output_literal ";----------------------------------------------------"
 MOM_output_literal "; T$mom_tool_number -  $mom_tool_name  D[format %.1f $mom_tool_diameter]"
 MOM_output_literal ";===================================================="
}
