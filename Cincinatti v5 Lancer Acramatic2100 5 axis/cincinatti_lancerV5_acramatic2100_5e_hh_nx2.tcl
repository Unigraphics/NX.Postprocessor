########################## TCL Event Handlers ##########################
#
#  Created by Suderman  @  Thu Oct 06 15:25:02 2005 Pacific Daylight Time
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_4th_axis_max_limit                "40" 
  set mom_kin_4th_axis_min_incr                 "0.001"
  set mom_kin_4th_axis_min_limit                "-40"
  set mom_kin_4th_axis_plane                    "ZX" 
  set mom_kin_4th_axis_point(0)                 "0.0"
  set mom_kin_4th_axis_point(1)                 "0.0"
  set mom_kin_4th_axis_point(2)                 "200.0"
  ...
  set mom_kin_5th_axis_center_offset(2)         "-200"
  ...
  set mom_kin_linearization_tol                 "0.002"
  ...
  set mom_kin_pivot_gauge_offset                "200"
  ...
  set mom_kin_x_axis_limit                      "2032"
  set mom_kin_y_axis_limit                      "762"
  set mom_kin_z_axis_limit                      "770"
...
#=============================================================
   ...
   MOM_force Once G_motion fifth_axis fourth_axis
   MOM_do_template reset_AB
...
return [tk_messageBox -type ok -icon error -message "$res"]
   ...
   puts $tmp_file "      Z\[\$mom_cycle_feed_to\]"
   ...
   puts $tmp_file "      cycle_R\[\$mom_cycle_rapid_to_pos(2)-\$cycle_gage\]"
   puts $tmp_file "      cycle_J\[\$cycle_angle\]"
   puts $tmp_file "      cycle_V\[\$cycle_offset(1)\]"
   puts $tmp_file "      M_spindle\[\$mom_sys_spindle_direction_code(\$mom_spindle_direction)\]\\opt"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE linearizacao"
   puts $tmp_file "  \{"
   ...
   puts $tmp_file "      G_feed\[\$tipo_feed\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_linear_code\]"
   puts $tmp_file "      X\[\$xx1\]"
   puts $tmp_file "      Y\[\$yy1\]"
   puts $tmp_file "      Z\[\$zz1\]"
   puts $tmp_file "      fourth_axis\[\$aa1\]"
   puts $tmp_file "      fifth_axis\[\$bb1\]"
   puts $tmp_file "      F\[\$feed\]"
   puts $tmp_file "      S\[\$mom_spindle_speed\]"
   puts $tmp_file "      M_spindle\[\$mom_sys_spindle_direction_code(\$mom_spindle_direction)\]\\opt"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE from_move_1"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      X\[\$mom_from_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_from_pos(1)\]"
   puts $tmp_file "      fourth_axis\[\$mom_out_angle_pos(0)\]"
   puts $tmp_file "      fifth_axis\[\$mom_out_angle_pos(1)\]"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   ...
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$tipo_feed\]"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE reset_AB"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE rapid_traverse_yz"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$tipo_feed\]"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      G_mode\[\$mom_sys_output_code(\$mom_output_mode)\]\\opt"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE rapid_xyz"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$tipo_feed\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      X\[\$mom_pos(0)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE rapid_traverse_xy"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$tipo_feed\]"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      G_mode\[\$mom_sys_output_code(\$mom_output_mode)\]\\opt"
   ...
   puts $tmp_file "      S\[\$mom_spindle_speed\]"
   puts $tmp_file "      cycle_R\[\$mom_cycle_rapid_to_pos(2)-\$cycle_gage\]"
   puts $tmp_file "      cycle_J\[\$cycle_deep_type\]"
   puts $tmp_file "      cycle_step\[\$mom_cycle_step1\]"
   puts $tmp_file "      M_spindle\[\$mom_sys_spindle_direction_code(\$mom_spindle_direction)\]\\opt"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE rapid_traverse_zx"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$tipo_feed\]"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      G_mode\[\$mom_sys_output_code(\$mom_output_mode)\]\\opt"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE gohome_move_1"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      X\[\$mom_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_pos(1)\]"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_feed G_motion G_mode X Y Z fifth_axis fourth_axis S M_spindle}
   set rapid_traverse_xy_blk {G_feed G_motion G_mode X Y fifth_axis fourth_axis S M_spindle}
   set rapid_traverse_yz_blk {G_feed G_motion G_mode Y Z fifth_axis fourth_axis S M_spindle}
   set rapid_traverse_xz_blk {G_feed G_motion G_mode X Z fifth_axis fourth_axis S M_spindle}
...
set tempo_anterior   0
 ...
 MOM_output_literal ":$co $mom_output_file_basename $ci"
 ...
 MOM_output_literal "$co MAQUINA  : CINCINNATI LANCER 5 EIXOS - COMANDO: ACRAMATIC $ci"
...
global mom_tool_type mom_tool_barrel_radius mom_tool_shank_diameter
global mom_tool_upper_corner_radius mom_tool_lower_corner_radius
global co ci

  MOM_output_literal ":$co OPERACAO   : $mom_path_name $ci"
  if {$mom_tool_type == "Milling Tool-Barrel"} {
      MOM_output_literal "$co  FERRAMENTA  : $mom_tool_name - T$mom_tool_number - D[format "%.2f" $mom_tool_diameter] x d[format "%.2f" $mom_tool_shank_diameter] - R[format "%.2f" $mom_tool_barrel_radius] - Rinf=[format "%.2f" $mom_tool_lower_corner_radius] - Rsup=[format "%.2f" $mom_tool_upper_corner_radius] - FL[format "%.2f" $mom_tool_flute_length] - LT[format "%.2f" $mom_tool_length] $ci"
  } else {
          MOM_output_literal "$co  FERRAMENTA  : $mom_tool_name - T$mom_tool_number - D[format "%.2f" $mom_tool_diameter] - R[format "%.2f" $mom_tool_corner1_radius] - FL[format "%.2f" $mom_tool_flute_length] - LT[format "%.2f" $mom_tool_length] $ci"
  }
  MOM_output_literal "$co  PECA        : $mom_part_name $ci"
  MOM_output_literal "$co  GERADO EM   : $mom_date $ci"
  MOM_output_literal "$co =========================================================================================================== $ci"
}
...
#=============================================================
proc PB_CMD_verif_usr_reset_AB { } {
#=============================================================
global usr_reset_AB
