...
#
#  Created by zhang  @  Thu May 15 17:24:01 2008 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_post_description                  "The post for Mori_Seiki_AL_22_MF_T4.\n\
                                                 1.Range specify;\n\
...
#=============================================================
   ...
   MOM_do_template end_of_path_cut_num
   MOM_force Once M_coolant
   MOM_do_template end_of_path_2
   PB_CMD_custom_next_tool_num
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   MOM_force Once T M_range
   MOM_do_template spindle_range_type
   PB_CMD_custom_spindle_output
...
MOM_output_literal "*********************************"
MOM_output_literal "*************mom_feed_rate********************"
MOM_output_literal "$mom_feed_rate"
MOM_output_literal "*************mom_programmed_feed_rate********************"
MOM_output_literal "$mom_programmed_feed_rate"
MOM_output_literal "*************mom_feed_rate_per_rev********************"
MOM_output_literal "$mom_feed_rate_per_rev"
MOM_output_literal "*********************************"
}
...
#=============================================================
proc PB_CMD_custom_next_tool_num { } {
#=============================================================
#It must output the 2 formats:
#End of Operation
#T0100
#G28 U0 W0 M09
#T0200
...
#M01
#
#Depend on the value of mom_next_tool_status
#This value will either be NEXT or FIRST
#if FIRST, it means at the end of the program.


global mom_next_tool_status

#MOM_output_literal "###############################"
#MOM_output_literal "$mom_next_tool_status"
#MOM_output_literal "###############################"
if { $mom_next_tool_status == "NEXT" } {
	MOM_force once T_Num
        MOM_do_template end_of_path_cut_num_next

#MOM_output_literal "================================"
} elseif { $mom_next_tool_status == "FIRST" } {
#MOM_output_literal "******************************"
	MOM_force once T_Num
        MOM_do_template end_of_path_cut_num_next
	MOM_force once M_spindle
        MOM_do_template m_05
...
#=============================================================
proc PB_CMD_custom_spindle_output { } {
#=============================================================
#Today,China got a big earthquake in Sichuan province, pray for all the people
#output user defined spindle
#G96 SFM G97 RPM
