...
#
#  Created by suderman  @  Mon Mar 31 10:43:06 2008 Pacific Daylight Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_post_description                  "This is the post for Tree."
...
#=============================================================
   CIRCLE_SET
   PB_CMD_output_circular_direction
   MOM_force Once G_motion circular_direction_code
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_motion user_G0 X Y Z}
   set rapid_spindle_x_blk {G_motion user_G0 X}
   set rapid_spindle_y_blk {G_motion user_G0 Y}
   set rapid_spindle_z_blk {G_motion user_G0 Z}
   set rapid_traverse_blk {G_motion user_G0 X Y Z M_spindle S}
   set rapid_traverse_xy_blk {G_motion user_G0 X Y M_spindle S}
   set rapid_traverse_yz_blk {G_motion user_G0 Y Z M_spindle S}
   set rapid_traverse_xz_blk {G_motion user_G0 X Z M_spindle S}
   set rapid_traverse_mod {G_motion user_G0}
   set rapid_spindle_mod {G_motion user_G0}
...
#=============================================================
   ...
   MOM_force Once M_spindle T S
   MOM_do_template tool_change_sequence
   MOM_force Once M_coolant
   MOM_do_template auto_tool_m_08
}
...
global mom_prev_feed_rate
# X_Y not change ,Z change********
if {$mom_pos(0) == $mom_prev_pos(0) && $mom_pos(1) == $mom_prev_pos(1) && $mom_pos(2) != $mom_prev_pos(2) } {
MOM_force once G_motion
MOM_do_template linear_move_z
} elseif {$mom_pos(2) == $mom_prev_pos(2)} {
# Z not change ,X_Y change********
if { $mom_pos(0) != $mom_prev_pos(0) || $mom_pos(1) != $mom_prev_pos(1) } {
MOM_force once G_motion
MOM_do_template linear_move_x_y
}
} elseif { $mom_pos(0) == $mom_prev_pos(0) && $mom_pos(1) == $mom_prev_pos(1) && $mom_pos(2) == $mom_prev_pos(2) && $mom_feed_rate == $mom_prev_feed_rate } {
# X_Y_Z_F not change***************
} else {
# other****************************
MOM_force once G_motion
...
#=============================================================
proc PB_CMD_output_circular_direction { } {
#=============================================================
global mom_arc_direction
global mom_arc_direction_code

if {$mom_arc_direction == "CLW"} {
set mom_arc_direction_code 0
} else {
set mom_arc_direction_code 1
}
#MOM_output_literal "***************************"
#MOM_output_literal "$mom_arc_direction_code"
#MOM_output_literal "$mom_arc_direction"
#MOM_output_literal "***************************"
}
