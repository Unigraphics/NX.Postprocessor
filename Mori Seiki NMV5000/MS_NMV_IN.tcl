...
#  MS_NMV_IN.tcl -
#
#  Created by suyo  @  Thu Apr 24 18:03:02 2008 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_post_description                  "This is a 5-Axis Milling Machine With Dual Rotary Tables.\n\
                                                 Mori Seiki NMV"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_4th_axis_max_limit                "170"
  set mom_kin_4th_axis_min_incr                 "0.001"
  set mom_kin_4th_axis_min_limit                "-170"
  ...
  set mom_kin_5th_axis_max_limit                "9999.99"
  set mom_kin_5th_axis_min_incr                 "0.001"
  set mom_kin_5th_axis_min_limit                "-9999.99"
  ...
  set mom_kin_x_axis_limit                      "28.7"
  set mom_kin_y_axis_limit                      "20.1"
  set mom_kin_z_axis_limit                      "20.1"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_adjust G_motion G_mode X Y Z S H M_spindle}
   set rapid_traverse_xy_blk {G_adjust G_motion G_mode X Y S H M_spindle}
   set rapid_traverse_yz_blk {G_adjust G_motion G_mode Y Z S H M_spindle}
   set rapid_traverse_xz_blk {G_adjust G_motion G_mode X Z S H M_spindle}
...
#=============================================================
  ...
  global first_linear_move ; set first_linear_move 0
   ...
   MOM_output_literal "(Current Tool: $mom_tool_number)"
...
if {[info exists is_HPCC_mode]} {
  if { $is_HPCC_mode == "ON" } {
    MOM_output_literal "(AI CONTOUR CONTROL MODE OFF)"
...
if {[info exists mom_kin_read_ahead_motion]} {
unset mom_kin_read_ahead_motion
mom_reload_kinematics
}
...
global mom_command_status 
   ...
   if { $mom_command_status == "ACTIVE"} {       
             MOM_output_literal "(AI CONTOUR CONTROL MODE ON)"
             MOM_force ONCE Macro_call HPCC_mode           
