########################## TCL Event Handlers ##########################
#
#  Created by ugii  @  Fri Mar 26 14:46:11 2004 E. South America Daylight Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_lathe_postname                    "okuma_lt25_ospe100l"
...
return
   ...
   if { $mom_machine_mode == "MILL" } {
      ...
      set UGII_CAM_POST_DIR  "[MOM_ask_env_var UGII_CAM_POST_DIR]"
      set mom_load_event_handler   "\"$UGII_CAM_POST_DIR$mom_sys_lathe_postname.tcl\""
      MOM_load_definition_file     "$UGII_CAM_POST_DIR$mom_sys_lathe_postname.def"
...
set mom_machine_name OKUMA_LT_25
