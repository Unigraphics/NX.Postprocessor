########################## TCL Event Handlers ##########################
#
#  Created by suyo  @  Tue Sep 19 14:36:24 2006 China Standard Time
...
#=============================================================
   MOM_do_template end_of_program_M06l
...
#=============================================================
  ...
  global first_linear_move ; set first_linear_move 0
   ...
   MOM_output_literal "(tool number: $mom_tool_number)"
}
...
#=============================================================
   ...
   MOM_do_template rewind_stop_code
   MOM_set_seq_on
   MOM_force Once G_cutcom G_plane
...
#=============================================================
global vertical_head_flag
global tool_change_position

#if the head is changed, then change it to vertical head
if { [EQ_is_zero $vertical_head_flag] } {
  if {!$tool_change_position} {
       MOM_force Once G_mode G Z
       MOM_do_template tool_change      
      }  
  MOM_output_literal "G65 P9021 T1000 E1100"
}
}
...
#=============================================================
proc PB_CMD_head_select { } {
#=============================================================
global mom_pos
global mom_prev_pos
global tool_change_position
global has_output_G69
global vertical_head_flag

if { !$vertical_head_flag } {
if { $mom_pos(3) != $mom_prev_pos(3) } { 

 if [info exists has_output_G69] {
   if { !$has_output_G69 } {   
    MOM_output_literal "G69"
    set has_output_G69 0 
   }
  }
  ...
  MOM_do_template head_position
}
}
   set tool_change_position 0
}
...
# It doesn't need to prepare the tool at the last operation
...
#=============================================================
proc PB_CMD_select_head { } {
#=============================================================
global first_spindle_axis
global vertical_head_flag
...
global tool_change_position
 ...
 if {$first_spindle_axis } { 

    set first_spindle_axis 0  
  
   if [EQ_is_equal [expr abs($mom_head_spindle_axis(2))] 1.0] {    
      set vertical_head_flag 1
      if {!$tool_change_position} {
         MOM_force Once G_mode G Z
         MOM_do_template tool_change
         set tool_change_position 1
        }
      MOM_output_literal "G65 P9021 T1000 E1100"
    } else {
      set vertical_head_flag 0
      if {!$tool_change_position} {
         MOM_force Once G_mode G Z
         MOM_do_template tool_change
         set tool_change_position 1
        }      
      MOM_output_literal "G65 P9021 T1100 E1000"  
    }
...
#the head change events will lead a tool change event, 
#if the next tool use the same tool, here this need to omit the tool preselect
#if not, we should preselect the tool for next operation.
       MOM_force Once T
       MOM_do_template tool_change_2
       }
    } else {
...
#=============================================================
proc PB_CMD_select_head_1 { } {
#=============================================================
global first_spindle_axis
global first_horizontal_head

global mom_head_spindle_axis
global vertical_head_flag
global horizontal_head_position
global prev_horizontal_head_position
 ...
 if {$first_spindle_axis } { 
    ...
    if [EQ_is_equal [expr abs($mom_head_spindle_axis(0))] 1.0] {
    # the spindle is along the x axis
  
      set vertical_head_flag 0
      set first_horizontal_head 1

      MOM_output_literal "G65 P9021 T1000 E1100"
      if [EQ_is_equal $mom_head_spindle_axis(0) 1.0] {

         set horizontal_head_position "BACK"
         set prev_horizontal_head_position $horizontal_head_position
         MOM_output_literal "M55 B90"

         } else {

          set horizontal_head_position "FRONT"
          set prev_horizontal_head_position $horizontal_head_position
          MOM_output_literal "M55 B270"
         }      
     }

   if [EQ_is_equal [expr abs($mom_head_spindle_axis(1))] 1.0] {
    # the spindle is along the y axis

      set vertical_head_flag 0
      set first_horizontal_head 1

      MOM_output_literal "G65 P9021 T1000 E1100"
      if [EQ_is_equal $mom_head_spindle_axis(1) 1.0] {

         set horizontal_head_position "LEFT"
         set prev_horizontal_head_position $horizontal_head_position
         MOM_output_literal "M55 B180"
      } else {

         set horizontal_head_position "RIGHT"
         set prev_horizontal_head_position $horizontal_head_position
         MOM_output_literal "M55 B0"
      }    
    }
   ...
   if [EQ_is_equal [expr abs($mom_head_spindle_axis(2))] 1.0] {    
    ...
    # the spindle is along the x axis
      ...
      if [EQ_is_equal $mom_head_spindle_axis(0) 1.0] {
         ...
         if { !$first_horizontal_head } {
            if { $prev_horizontal_head_position != $horizontal_head_position } {
            MOM_output_literal "M55 B90"
            }
         } else {
            set first_horizontal_head 0
            MOM_output_literal "M55 B90"
         }
      } else {
         set horizontal_head_position "FRONT"
...
#=============================================================
proc PB_CMD_start_of_operation { } {
#=============================================================
global next_tool_flag
global mom_next_oper_has_tool_change

if {[info exists mom_next_oper_has_tool_change]} {
    if {$mom_next_oper_has_tool_change == "YES"} { 
      set next_tool_flag 1
  }
 }
}
...
set first_spindle_axis 1
set first_horizontal_head 1

# I think the initial head is vertical
set vertical_head_flag 1
...
if [info exist next_oper_has_tool_change] {
if { $next_oper_has_tool_change } {
   if { !$vertical_head_flag } {
   MOM_output_literal "G69"
    set has_output_G69 1 
   }
   set next_oper_has_tool_change 0
}
}
