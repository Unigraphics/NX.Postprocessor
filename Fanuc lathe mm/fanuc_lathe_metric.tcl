########################## TCL Event Handlers ##########################
#
#  Created by maozhi  @  Thu Apr 21 10:28:02 2005 China Standard Time
...
# This custom command is for tool_change
        ...
        MOM_output_literal "$mom_sys_control_out Tool Name  : $mom_tool_name  Tool Diameter: [format "%5.3f" $mom_tool_diameter] $mom_sys_control_in"
        MOM_set_seq_on
}
