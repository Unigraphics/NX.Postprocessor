...
#
#  Created by suyo  @  Thu Dec 27 11:18:22 2007 China Standard Time
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_mode G_motion Text X Y Z}
   set rapid_traverse_xy_blk {G_mode G_motion Text X Y}
   set rapid_traverse_yz_blk {G_mode G_motion Text Y Z}
   set rapid_traverse_xz_blk {G_mode G_motion Text X Z}
