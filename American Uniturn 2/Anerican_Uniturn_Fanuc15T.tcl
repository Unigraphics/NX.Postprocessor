...
#
#  Created by wrightj  @  Tue May 27 11:21:52 2008 Central Daylight Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_spindle_param(1,min)              "4"  
  set mom_sys_spindle_range_code(2)             "42" 
  set mom_sys_spindle_param(2,max)              "85" 
  set mom_sys_spindle_param(2,min)              "31" 
  set mom_sys_spindle_range_code(3)             "43" 
  set mom_sys_spindle_param(3,max)              "300"
  set mom_sys_spindle_param(3,min)              "86" 
  set mom_sys_spindle_range_code(4)             "44" 
  set mom_sys_spindle_param(4,max)              "1000"
  set mom_sys_spindle_param(4,min)              "301"
  ...
  set mom_sys_head_code(INDEPENDENT)            "21" 
  set mom_sys_head_code(DEPENDENT)              "22" 
  set mom_sys_post_description                  "This is a post for Warren Pump Anerican Uniturn Fanuc 15T."
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_x_axis_limit                      "31" 
  set mom_kin_y_axis_limit                      "40" 
  set mom_kin_z_axis_limit                      "157"
...
set work_coordinate_number $mom_work_coordinate_number
MOM_output_literal "$work_coordinate_number"
...
MOM_output_literal "$work_coordinate_number"
MOM_output_literal "$mom_work_coordinate_number"
}
...
MOM_output_text "$mom_coolant_status"
MOM_output_text "$mom_coolant_mode"
}
