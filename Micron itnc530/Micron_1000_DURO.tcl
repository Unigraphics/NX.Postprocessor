########################## TCL Event Handlers ##########################
#
#  Created by bcurwood  @  Thu Mar 25 15:06:10 2004 Pacific Daylight Time
...
#=============================================================
proc PB_CMD_output_operation_name { } {
#=============================================================
# This proceedure will output the name of the operation as an operator
# message when the
# operation is named liked this:  mill_top_of_part_0010
# the last 4 characters are stripped off


global mom_operation_name

set len [string length $mom_operation_name]
set en [expr $len - 0]
set tmm [string range $mom_operation_name 0 $en]
MOM_output_literal ";(*********DESCRIPTION: $tmm**************)"
}


#=============================================================
proc PB_CMD_output_part_name { } {
#=============================================================
# This proceedure will output the name of the part as an operator



global mom_part_name

set len [string length $mom_part_name]
set en [expr $len - 0]
set tmm [string range $mom_part_name 0 $en]
MOM_output_literal ";(*********DESCRIPTION: $tmm**************)"
}
