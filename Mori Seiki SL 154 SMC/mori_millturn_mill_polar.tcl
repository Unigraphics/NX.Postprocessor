########################## TCL Event Handlers ##########################
#
#  Created by mannino  @  Mon Sep 13 18:32:48 2004 Eastern Standard Time
...
#=========================
 ...
 set mom_sys_postname(SUB)                     "mori_millturn_lathe_sub"
 set mom_sys_postname(SIDE)                    "mori_millturn_mill_x"
 set mom_sys_postname(TURN)                    "mori_millturn_lathe"
 set mom_sys_postname(POLARZ)                  "mori_millturn_mill_polar"
...
#=============================================================
   CIRCLE_SET
   MOM_force Once G_motion X fourth_axis R
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   PB_CMD_x_axis_multiplier
   set rapid_traverse_blk {G_feed G_motion X Z fourth_axis S M_spindle M_coolant}
...
#=============================================================
  global cycle_init_flag
   ...
   MOM_force Once fourth_axis cycle_step
...
set mom_out_angle_pos(0) $mom_pos(1)
}
...
MOM_output_text "(============================)"
MOM_output_text "(Z AXIS SAFE INDEX POSITION)"
MOM_output_text "#500=-7."
MOM_output_text "(============================)"
}
