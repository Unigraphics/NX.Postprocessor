########################## TCL Event Handlers ##########################
#
#  Created by daniels  @  Fri Dec 01 12:48:13 2006 GMT Standard Time
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_cutcom G_motion G_mode X Y Z fourth_axis M_coolant}
   set rapid_traverse_xy_blk {G_cutcom G_motion G_mode X Y fourth_axis M_coolant}
   set rapid_traverse_yz_blk {G_cutcom G_motion G_mode Y Z fourth_axis M_coolant}
   set rapid_traverse_xz_blk {G_cutcom G_motion G_mode X Z fourth_axis M_coolant}
...
#=============================================================
# qualified machine has a A-axis rotary table ( YZ Plane)

# Threadmill
# contains CYCL/TEXT implementation of INNER/OUTER with sidepasses
# Auto axis clamping codes removed. controller undertakes this automatically
# 16 October 2006
}
...
MOM_output_literal "( HAAS VF2_with_A-AXIS Rotart Table POSTPROCESSOR VERSION $pn_version ) "
...
#=============================================================
global pn_version
set pn_version 1.0 ;# Generic 4 axis rotart table ( A-axis)
