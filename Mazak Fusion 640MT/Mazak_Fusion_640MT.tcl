...
#
#  Created by xiongx  @  Thu Jan 10 21:41:49 2008 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_spindle_range_code(1)             "37" 
  set mom_sys_spindle_param(1,max)              "535"
  set mom_sys_spindle_param(1,min)              "6"  
  set mom_sys_spindle_range_code(2)             "38" 
  set mom_sys_spindle_param(2,max)              "1037"
  set mom_sys_spindle_param(2,min)              "11" 
  set mom_sys_spindle_range_code(3)             "39" 
  set mom_sys_spindle_param(3,max)              "2196"
  set mom_sys_spindle_param(3,min)              "22" 
...
#=============================================================
  MOM_force once X Z M_spindle M_coolant F G_feed G
}
...
#=============================================================
  ...
  global myfirst_linear_move

#MOM_output_literal "_____$first_linear_move"
  if {$myfirst_linear_move == 0} {return} else {
...
#=============================================================
global myfirst_linear_move
global myfirst_rapid_move

#MOM_output_literal "______$first_linear_move"
set myfirst_linear_move 1
set myfirst_rapid_move 1
}
