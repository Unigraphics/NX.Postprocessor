...
#  Kuraki_KBT-11DX.tcl -
#
#  Created by xiongx  @  Tue Jul 08 10:16:27 2008 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_optional_stop_code                "01" 
  set mom_sys_end_of_program_code               "02" 
  set mom_sys_spindle_direction_code(CLW)       "3"  
  set mom_sys_spindle_direction_code(CCLW)      "4"  
  set mom_sys_spindle_direction_code(OFF)       "5"  
  set mom_sys_tool_change_code                  "906"
...
#=============================================================
   ...
   MOM_force Once G_mode G G53 Z_pos W_pos H0
   MOM_do_template end_of_path_return_zw
   MOM_force Once G X Y
   MOM_do_template end_of_path_return_xy
   MOM_force Once M
   MOM_do_template opstop
   MOM_force Once G_plane
   MOM_do_template end_of_program_G17
   MOM_force Once G_mode G G_motion X Y Z_pos W_pos
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_mode G_motion G_adjust X Y Z H M_coolant}
   set rapid_spindle_x_blk {G_mode G_motion G_adjust X H M_coolant}
   set rapid_spindle_y_blk {G_mode G_motion G_adjust Y H M_coolant}
   set rapid_spindle_z_blk {G_mode G_motion G_adjust Z H M_coolant}
   set rapid_traverse_blk {G_mode G_motion X Y Z S M_spindle}
   set rapid_traverse_xy_blk {G_mode G_motion X Y S M_spindle}
   set rapid_traverse_yz_blk {G_mode G_motion Y Z S M_spindle}
   set rapid_traverse_xz_blk {G_mode G_motion X Z S M_spindle}
...
MOM_force once G G_mode G53 Z_pos W_pos H0
MOM_do_template end_of_path_return_zw
MOM_do_template coolant_off
MOM_do_template spindle_off
MOM_force once G
MOM_do_template end_of_path_return_xy
MOM_do_template opstop
#MOM_output_literal "G91G28G53G00Z0.W0.H0"
}
}
...
#=============================================================
   ...
   switch $mom_axis_position {
      ZAXIS { 
		 ...
		 set mom_sys_quill_pos $mom_axis_position_value
         #MOM_force once Z
      ...
      WAXIS  { 
         ...
         set mom_sys_zaxis_pos $mom_axis_position_value
		 set mom_sys_table_pos $mom_axis_position_value
         #MOM_force once Z
         #MOM_do_template zaxis_move
...
#=============================================================
proc PB_CMD_output_B { } {
#=============================================================
#
#  This custom command allows you to output B axis
#

global mom_out_angle_pos  mom_prev_out_angle_pos

if {![info exists mom_out_angle_pos]} {
#MOM_output_literal "not existed"
return
} elseif {![info exists mom_prev_out_angle_pos] && [EQ_is_zero $mom_out_angle_pos(0)]} {
#MOM_output_literal "prev not existed $$ angle is 0"
return
} elseif {[info exists mom_prev_out_angle_pos] && [EQ_is_equal  $mom_out_angle_pos(0) $mom_prev_out_angle_pos(0)]} {
#MOM_output_literal "is equall"
#MOM_output_literal "mom_out_angle_pos(0) = $mom_out_angle_pos(0)"
return
} else {

#MOM_set_seq_off
#MOM_output_literal "(Output B)OM

MOM_force once G_mode G_motion fourth_axis M
MOM_do_template output_M11
MOM_do_template output_B
MOM_do_template output_M10
}
}


#=============================================================
proc PB_CMD_output_zw { } {
#=============================================================
...
MOM_force once G_motion G_mode Z_pos W_pos G_adjust 
MOM_do_template init_move_w_quill
MOM_force once G_motion G_mode Z_pos W_pos G_adjust 
MOM_do_template init_move_z_quill
}
if { $mom_axis_position == "WAXIS" } {
MOM_force once G_motion G_mode Z_pos W_pos G_adjust 
MOM_do_template init_move_w_table
MOM_force once G_motion G_mode Z_pos W_pos G_adjust 
MOM_do_template init_move_z_table
}
}
...
#=============================================================
proc PB_CMD_returnZWH { } {
#=============================================================
MOM_output_literal "G91G28G53Z0.W0.H0"
}
...
#MOM_output_literal "mom_sys_zw_mode=$mom_sys_zw_mode"
#MOM_output_literal "mom_sys_table_leader=$mom_sys_table_leader"
#MOM_output_literal "mom_sys_quill_pos=$mom_sys_quill_pos"
   if {$mom_sys_zw_mode != $mom_sys_table_leader} {
...
#
   ...
   global mom_cycle_feed_to mom_cycle_rapid_to
#MOM_output_literal "mom_sys_zw_mode=$mom_sys_zw_mode"
#MOM_output_literal "mom_sys_quill_leader=$mom_sys_quill_leader"
#MOM_output_literal "mom_sys_table_pos=$mom_sys_table_pos"
   if {$mom_sys_zw_mode != $mom_sys_quill_leader} {
      set mom_sys_zw_mode $mom_sys_quill_leader
      set mom_sys_leader(Z) $mom_sys_quill_leader
...
#=============================================================
  global mom_feed_rate mom_feed_rate_per_rev mom_motion_type
  global mom_kin_max_fpm mom_motion_event mom_operation_name
  COOLANT_SET ; CUTCOM_SET ; SPINDLE_SET ; RAPID_SET
  PB_CMD_output_B
  MOM_do_template tool_select
  MOM_do_template tool_change_M906
  MOM_set_seq_off
...
#MOM_output_literal "mom_sys_zw_mode == $mom_sys_table_leader"
      #MOM_output_literal "mom_sys_z_pos = $mom_sys_z_pos"
      #MOM_output_literal "mom_sys_quill_pos = $mom_sys_quill_pos"
      set mom_pos(2) [expr $mom_sys_z_pos - $mom_sys_quill_pos]
      if [info exists mom_cycle_feed_to_pos] {
         set mom_cycle_feed_to_pos(2)  [expr $mom_sys_cycle_z_pos + $mom_cycle_feed_to - $mom_sys_quill_pos]
