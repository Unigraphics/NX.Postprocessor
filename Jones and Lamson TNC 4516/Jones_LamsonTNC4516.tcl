########################## TCL Event Handlers ##########################
#
#  Jones&LamsonTNC4516.tcl -
#
#  Created by xiongx  @  Tue Jan 08 21:46:31 2008 China Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_spindle_param(2,max)              "534"
  set mom_sys_spindle_param(2,min)              "9"  
  set mom_sys_spindle_range_code(3)             "43" 
  set mom_sys_spindle_param(3,max)              "1600"
  set mom_sys_spindle_param(3,min)              "27" 
...
if {$mom_tool_number > 0 && $mom_tool_number < 9} {
MOM_output_literal "M60"
MOM_output_literal "M6$mom_tool_number"} elseif {$mom_tool_number > 8 && $mom_tool_number < 15} {
MOM_output_literal "M70"
MOM_output_literal "M7[expr $mom_tool_number-8]"
}
...
MOM_output_literal "mom_spindle_range is $mom_spindle_range"
#set mom_spindle_range $mom_spindle_rpm
