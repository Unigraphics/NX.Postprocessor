########################## TCL Event Handlers ##########################
#
#  Created by maozhi  @  Wed Apr 20 16:48:00 2005 China Standard Time
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_adjust G_motion G_mode X Y Z M_coolant rapid_non_modal}
   set rapid_spindle_x_blk {G_adjust G_motion G_mode X M_coolant rapid_non_modal}
   set rapid_spindle_y_blk {G_adjust G_motion G_mode Y M_coolant rapid_non_modal}
   set rapid_spindle_z_blk {G_adjust G_motion G_mode Z M_coolant rapid_non_modal}
   set rapid_traverse_blk {G_motion G_mode X Y Z S M_spindle rapid_non_modal}
   set rapid_traverse_xy_blk {G_motion G_mode X Y S M_spindle rapid_non_modal}
   set rapid_traverse_yz_blk {G_motion G_mode Y Z S M_spindle rapid_non_modal}
   set rapid_traverse_xz_blk {G_motion G_mode X Z S M_spindle rapid_non_modal}
...
# This custom command is for tool_change
        ...
        MOM_output_literal "$mom_sys_control_out Tool Name  : $mom_tool_name  Tool Diameter: [format "%5.3f" $mom_tool_diameter]  Tool Length: [format "%5.3f" $mom_tool_length] $mom_sys_control_in"
        MOM_set_seq_on
}
...
#***************************
 set user_tcl_file ${cam_post_dir}bostomatic_mill_3_metric_user.tcl
