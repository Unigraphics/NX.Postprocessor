...
#  KOMO_3X_Router.tcl -
#
#  Created by burton  @  Wed Jan 16 14:30:42 2008 Central Daylight Time
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_x_axis_limit                      "150"
  set mom_kin_y_axis_limit                      "100"
  set mom_kin_z_axis_limit                      "5"  
...
#=============================================================
   ...
   MOM_do_template return_motion_end
   MOM_force Once G_return G_mode
   MOM_do_template return_motion_end_1
   MOM_force Once G_mode
   MOM_do_template absolute_mode1
   MOM_force Once Text X Y Z
   MOM_do_template fixture_offset_end
   MOM_force Once Text Text
...
#=============================================================
  ...
  global first_linear_move ; set first_linear_move 0
   ...
   PB_CMD_start_of_operation_force_address
}
...
#=============================================================
   ...
   MOM_output_literal "($mom_tool_description)"
   MOM_force Once G_mode G Z_zero M_spindle
   MOM_do_template tool_change
   MOM_force Once G_mode T M
...
#=============================================================
   ...
   MOM_set_seq_on
   MOM_force Once Text G_cutcom G_plane G_motion G_mode G Z M_spindle
   MOM_do_template absolute_mode
   MOM_force Once G_mode
   MOM_do_template absolute_mode1
   MOM_force Once Text
   MOM_do_template coolant_on
   MOM_force Once Text X Y
...
#=============================================================
# Output customized time & date stamp
# Place this custom command at   Start of Program
...
set my_file_name [string toupper $mom_output_file_basename]
set prog_name [string toupper $mom_logname]
set my_time_stamp [string toupper $mom_date]
 
MOM_set_seq_off
MOM_output_literal "(*************************************************************)"
MOM_output_literal "(PROGRAM NO.:  $my_file_name.EIA)"
MOM_output_literal "(MACHINE    :  KOMO CNC ROUTER"
MOM_output_literal "(POSTED BY  :  $prog_name	DATE: $my_time_stamp)"
MOM_output_literal "(*************************************************************)"
}
...
#=============================================================
proc PB_CMD_date_time { } {
#=============================================================
#
#  This custom command outputs the date and time
#  
#
  global mom_date
...
#=============================================================
proc PB_CMD_output_tool_description { } {
#=============================================================
#
#  This custom command outputs the tool name
#  
#
  global mom_tool_name
...
#=============================================================
proc PB_CMD_start_of_operation_force_address { } {
#=============================================================
global mom_operation_name 
