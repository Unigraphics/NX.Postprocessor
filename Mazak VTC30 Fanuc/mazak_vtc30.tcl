...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   COOLANT_SET ; CUTCOM_SET ; SPINDLE_SET ; RAPID_SET
   PB_CMD_reposiciona
   MOM_force Once G_adjust G_motion G_mode H
...
MOM_output_literal "(TIEMPO DE LA OPERACION: $tempo_oper min.)"
...
MOM_output_literal "(TIEMPO TOTAL: $tempo_total min.)"
}
...
MOM_output_literal "( OPERACION    : $mom_path_name )"
MOM_output_literal "( HIERRAMIENTA : $mom_tool_name - T$mom_tool_number )"
   ...
   if {[info exists mom_sys_rotary_error] && [info exists mom_motion_event]} { 
     if {$mom_sys_rotary_error != 0 && $mom_motion_event == "linear_move"} { 
        ...
        # Retract from part
         ...
         if {$num_sol != 0} {
        #
        # Retract from the part at rapid feed rate
        #
