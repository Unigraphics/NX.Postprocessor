...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_feed G_motion G_mode X Y Z S M_spindle rapid_non_modal}
   set rapid_traverse_xy_blk {G_feed G_motion G_mode X Y S M_spindle rapid_non_modal}
   set rapid_traverse_yz_blk {G_feed G_motion G_mode Y Z S M_spindle rapid_non_modal}
   set rapid_traverse_xz_blk {G_feed G_motion G_mode X Z S M_spindle rapid_non_modal}
...
#=============================================================
proc PB_CMD_info_tool_library { } {
#=============================================================
# If this is a library tool, this will output some information
# from the tool library.
#
# It is just for testing and does  not  do much error checking.
# For example, the libref could be set from a previous tool.
...
if [info exists mom_libref] { 
  ...
  MOM_output_literal "$co This is a library tool $ci"

  MOM_ask_library_attributes LIBRARY_TOOL $mom_libref Type SubType Descr Holder HolderDes

  MOM_output_literal [format " %-15s %-2s %-2s %-30s %-3s %-30s" $mom_libref \
    $mom_lib_attr_value(Type) $mom_lib_attr_value(SubType) $mom_lib_attr_value(Descr) \
    $mom_lib_attr_value(Holder) $mom_lib_attr_value(HolderDes)]
...
#=============================================================
  MOM_force once M_spindle S X Y Z F R fourth_axis fifth_axis cycle_feedrate cycle_feed_to cycle_rapid_to
}
