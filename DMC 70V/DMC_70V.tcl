########################## TCL Event Handlers ##########################
#
#  Created by suyo  @  Thu Oct 26 09:45:02 2006 China Standard Time
...
#=============================================================
  global cycle_init_flag
   ...
   PB_CMD_cycle_init
   MOM_force Once G_motion X Y Text
...
#=============================================================
   ...
   MOM_force Once G_motion X Y circle_direction Text
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_motion X Y Z G_cutcom user_add Text M_spindle}
   set rapid_traverse_xy_blk {G_motion X Y G_cutcom user_add Text M_spindle}
   set rapid_traverse_yz_blk {G_motion Y Z G_cutcom user_add Text M_spindle}
   set rapid_traverse_xz_blk {G_motion X Z G_cutcom user_add Text M_spindle}
...
if {[info exists mom_next_oper_has_tool_change]} {
    if {$mom_next_oper_has_tool_change == "YES"} { 
      ...
      MOM_do_template return_motion      MO
    }
  }
}
